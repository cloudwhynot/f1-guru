...
### Section C > Article C1: GENERAL PRINCIPLES > C1.1 Formula One World Championship > C1.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 7
...
### Section C > Article C1: GENERAL PRINCIPLES > C1.2 Regulatory Framework > C1.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 7
...
### Section C > Article C1: GENERAL PRINCIPLES > C1.2 Regulatory Framework > C1.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 7
...
### Section C > Article C1: GENERAL PRINCIPLES > C1.3 Interpretation of and amendments to these Technical Regulations > C1.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 7
...
### Section C > Article C1: GENERAL PRINCIPLES > C1.3 Interpretation of and amendments to these Technical Regulations > C1.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 7
...
### Section C > Article C1: GENERAL PRINCIPLES > C1.3 Interpretation of and amendments to these Technical Regulations > C1.3.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 7
...
### Section C > Article C2: CONVENTIONS AND FUNDAMENTAL DIMENSIONS > C2.1 Coordinate systems and conventions > C2.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 10
...
c. A suffix may be used for local coordinates in specific rules, (e.g. X<sub>W</sub>, Y<sub>W</sub>, Z<sub>W</sub>), where these local axes are defined within a specific Article for local use.

d. Planes will be referred to as the axis to which they are normal to (e.g. X−Plane or X<sub>A</sub> = 300 plane).
...
### Section C > Article C2: CONVENTIONS AND FUNDAMENTAL DIMENSIONS > C2.1 Coordinate systems and conventions > C2.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 10

**C2.1.3** ###  Wheel Coordinate System

The “**Wheel Coordinate System**” is a local right-handed Cartesian \[X<sub>W</sub>, Y<sub>W</sub>, Z<sub>W</sub>] coordinate system and is defined in the following way for each wheel:
...
b. The X<sub>W</sub> axis lies in the inboard plane of the Wheel Rim and increases in the rearward direction. With the wheel in the straight-ahead position and the car at Legality Setup, the X<sub>W</sub> axis is parallel to the car’s X-Axis.

c. The Y<sub>W</sub> axis is coincident with the wheel’s axis of rotation and increases towards the plane Y=0. Referring to this axis, the terms “inboard” or “outboard” respectively refer to closer to or further away from the plane Y = 0.

d. The Z<sub>W</sub> axis lies in the inboard plane of the Wheel Rim and increases upwards.
...
c. The Plane X<sub>A</sub> = 0 is defined as the X-Plane that lies on the forward limit of the Survival Cell.

d. The Plane X<sub>C</sub> = 0 is defined as the X-Plane at the rear of the Cockpit.

e. The planes X<sub>F</sub> = 0 and X<sub>R</sub> = 0 are defined as the X-Planes which respectively pass through the origin of the two front or two rear Wheel Coordinate Systems, with the wheels in the straight-ahead position and the car at Legality Setup.

f. The plane X<sub>DIF</sub> = 0 is defined as the X-Plane containing the axis of rotation of the final drive as defined in Article C9.5.1.
...
### Section C > Article C2: CONVENTIONS AND FUNDAMENTAL DIMENSIONS > C2.3 Fundamental Dimensions > C2.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 11
...
### Section C > Article C2: CONVENTIONS AND FUNDAMENTAL DIMENSIONS > C2.3 Fundamental Dimensions > C2.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 12
...
### Section C > Article C2: CONVENTIONS AND FUNDAMENTAL DIMENSIONS > C2.3 Fundamental Dimensions > C2.3.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 12
...
### Section C > Article C2: CONVENTIONS AND FUNDAMENTAL DIMENSIONS > C2.3 Fundamental Dimensions > C2.3.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 12
...
### Section C > Article C2: CONVENTIONS AND FUNDAMENTAL DIMENSIONS > C2.3 Fundamental Dimensions > C2.3.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 12
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.2 General Principles > C3.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 13
...
Any device or structure designed to bridge the gap between the sprung part of the car and the ground is strictly prohibited. Apart from necessary parts for the adjustments described in Articles C3.10.10 and C3.11.6, and incidental movements from the steering system, any car system, device, or procedure that alters

the aerodynamic characteristics of the car through driver movement is forbidden. Furthermore, the aerodynamic effect of any component not classified as Bodywork must be incidental to its primary function. Designs intended to enhance any such aerodynamic effects are prohibited.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.2 General Principles > C3.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 14
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.2 General Principles > C3.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 14
...
b. in any X, Y and Z plane, or any X<sub>W</sub>, Y<sub>W</sub> and Z<sub>W</sub> plane for Wheel Bodywork, only contain a single section.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.2 General Principles > C3.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 14

**C3.2.5** ##  Trim and Combination

A “Trim and Combination” operation can only be performed once the parts to be trimmed are fully defined. The only regions of a volume that can be removed as part of a trimming process are those
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.2 General Principles > C3.2.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 15
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.2 General Principles > C3.2.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 15
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.2 General Principles > C3.2.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 15
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.3 Legality Checking > C3.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 16

**C3.3.2** ##  Physical legality checking

Cars may be measured during a Competition to check their conformance to the CAD models discussed in Article C3.3.1 and/or to ensure they remain inside the Reference Volumes. <mark>All measurement will be made relative to the coordinate system determined by the datum points required by C3.3.3.</mark>
...
c. A positional tolerance of ±2mm will be accepted for the Front Wing Bodywork, Rear Wing Bodywork, Exhaust Tailpipe, Floor Bodywork behind X<sub>R</sub> = −335, and Tail. This will be assessed by realigning each of the groups of Reference Volumes and Reference Surfaces that define the assemblies, by up to 2mm, from their original position, to best fit the measured geometry.

d. Irrespective of (b),  a tolerance of Z = ±2mm will be accepted for parts of the <mark>Floor Bodywork</mark>  forward of X<sub>R</sub>=−335 and <mark>Plank Assembly,</mark>  visible from below.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.3 Legality Checking > C3.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 17
...
Full details of the requirements are given in the document <mark>FIA-F1-DOC-007</mark>.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.3 Legality Checking > C3.3.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 17
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.4 Component Definition > C3.4.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 18
...
Any Bodywork subject to Final Assembly as per Article C3.12, must first be classified under one of the groups specified in Articles C3.5 to C3.11. Compliance of each Bodywork component with Article C3 will be assessed independently and before any Trim and Combination operations and Fillet application described in Article C3.12, and

any Aperture application described in Article C3.16. Compliance of the Aerodynamic Surfaces of each Bodywork component with Article C3 will be assessed independently and after their boundaries have been defined by Trim and Combination operations and Fillet application described in Article C3.12, and before any Aperture application described in Article C3.16.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.4 Component Definition > C3.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 18
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.4 Component Definition > C3.4.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 18
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.4 Component Definition > C3.4.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 18
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 19
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 19
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 19
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 20
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 20
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 20
...
<mark>c. above Z = 60, be no less than 4mm thick when measured normal to Floor Leading Edge Device Aerodynamic Surfaces only.</mark>
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 21
...
e. Rotated by ±5 Degrees about a Y-aligned axis that passes though the point \[X<sub>R</sub>, Z] = \[295, 200]
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 21
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 22
...
## <mark>C3.5.11 Floor Tyre IR Sensor</mark>

<mark>“Floor Tyre IR Sensor” Bodywork must:
...
d. fully enclose an infra-red sensor for measuring tyre temperature.</mark>

<mark>Floor Tyre IR Sensor Aerodynamic Surfaces must:
e. contain no radius of curvature less than 20mm.</mark>


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.12
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 22
...
<mark>h. Floor Tyre IR Sensor, if fitted.</mark>
...
<mark>m. any Floor Tyre IR Sensor remaining below Main Floor.</mark>
...
o. forward of X<sub>F</sub> = 1500, when viewed from the rear, fully obscure Floor Leading Edge Device.

p. when viewed from the side, fully obscure RS-FLOOR-BOARD.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.13
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 23
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.5 Floor Bodywork > C3.5.14
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 23
...
i. have a single inboard attachment location that lies between X<sub>F</sub> = 1775 and X<sub>R</sub> = 275.

ii. be fixed on its inboard end to the entirely sprung part of the car.

iii. be fixed on its outboard end to Floor Bodywork.

iv. have a circular cross section , except within 25mm of the inboard and outboard attachment points, or within 10mm of any adjustment mechanism.
...
c. The Plank Assembly must have three 34mm diameter holes whose axes are parallel to the Z−axis. The centres must lie on Y = 0 and have X-locations X<sub>F</sub> = 500, −600 ≥ X<sub>C</sub> ≥ −800, and 470 ≤ X<sub>PU</sub> ≤ 630. Furthermore, the centre of the rearmost hole must lie on or ahead of X<sub>R</sub> = −500.
...
wear, and conformity to this provision will be checked at the peripheries of the holes required by (c) above.

Evaluation of Skid wear will be made by physical measurement of the Skid with it removed from the car. The Measurement will be made with a micrometer with a 6.35mm diameter anvil.

When measured in this way, the entire periphery of each hole must be within the specified tolerance.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.6 Plank and Skids > C3.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 25
...
c. Between X<sub>F</sub> = 630 and X<sub>C</sub> = −800 and behind X<sub>C</sub> = −400, pocketing of the Plank is permitted between Z=-7 and Z=-0.5. The periphery of any pocket, in any Z-Plane, must be not less than 10mm from either the edges of the Plank or any holes or recesses in the Plank. In any vertical plane, the internal pocket Fillet Radii must be at least 3mm and in any Z-Plane, must be at least 10mm. Pockets may only be filled with a material having a specific gravity of less than 0.25.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.6 Plank and Skids > C3.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 25
...
<mark>c. If metallic, the Skid material around the rear-most hole in the plank must:</mark>

i. <mark>be made to the geometry defined by RV-SKID-REAR and associated drawing.</mark>

ii. <mark>be divided into three separate parts as defined in the Reference Volume.</mark>

d. Metallic Skids must be made from either:

iii. Titanium alloy Ti6Al4V (according to AMS4928 or AMS4911) in annealed condition. <mark>No additional heat treatment is permitted;</mark> or

iv. 17-4PH stainless steel (to AMS 5604 / ASTM A 693 or AMS 5643/ ASTM A 564). <mark>When the skid is new, its hardness must be no more than 38 HRC.</mark>

Furthermore, they may only be machined from solid and no processes (such as forging, rolling, welding, or coating) may be carried out either before or after machining.

The material to be used in each Competition is defined in <mark>FIA-F1-DOC-041</mark>.

The only permitted deviation from the specified geometry is the removal of minimum material for the fasteners.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.6 Plank and Skids > C3.6.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 26
...
f. The total area of the fasteners and any load spreading washers employed with them when viewed from below must be less than 10 000 mm<sup>2</sup>, the area of any single fastener plus its load-spreading washer may not exceed 500mm<sup>2</sup>.
...
b. when viewed from above, fully obscure RS-NOSE ahead of X<sub>A</sub> = 0.

Nose Aerodynamic Surfaces, must be Tangent Continuous, and in any X-Plane must:

c. contain no concave radius of curvature.

d. between X<sub>F</sub> = -950 and X<sub>A</sub> = 0, have a section that when viewed from above:

* i. is tangent to the Z-Axis at its outermost extremity.
* ii. contains no radius of curvature less than 45mm at X<sub>A</sub> = 0.
* iii. contains no radius of curvature less than 20mm forward of X<sub>A</sub> = 0.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.7 Front Bodywork > C3.7.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 27
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.7 Front Bodywork > C3.7.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 27
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.7 Front Bodywork > C3.7.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 28
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.7 Front Bodywork > C3.7.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 28
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.7 Front Bodywork > C3.7.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 28
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.7 Front Bodywork > C3.7.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 29
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.7 Front Bodywork > C3.7.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 29
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.8 Rear Bodywork > C3.8.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 29
...
g. rearward of X<sub>R</sub> = −300 and below Z = 350, the X component of any normal to the surface visible from the side must not be negative.

h. there must be no surface parallel to an X-Plane ahead of X<sub>R</sub> = −55.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.8 Rear Bodywork > C3.8.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 30
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.8 Rear Bodywork > C3.8.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 30
...
b. when viewed from below, be fully obscured by Floor Body forward of X<sub>R</sub> = 295.

c. below Z = 450, have up to three sections in any Z-Plane.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.9 Tail and Exhaust Tailpipe > C3.9.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 31
...
* i. between X<sub>R</sub> = 390 and X<sub>R</sub> = 400.
...
* i. The support <mark>is exempt from Article C3.2.4 and</mark> must lie in its entirety within an individual instance of RV-TAILPIPE-BRACKET.
...
l. The rearmost point of every individual Y-section, when projected in Z onto a plane through Z = 0, must produce a single tangent continuous curve with no radius of curvature less than 200mm.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 32
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 32
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 33
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 33
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 33
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 34
...
b. in any Z-Plane:
i. have a total area no greater than 6000 mm<sup>2</sup>.
ii. have a section thickness no more than 35mm when measured in the Y direction.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 34
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 34
...
g. when viewed from above, fully obscure Front Wing Strake forward of X<sub>F</sub> = −715, if fitted.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 34
...
Compared to the position of Front Wing Profiles defined in Article C3.10.1, adjustment not controlled by the FIA Standard ECU <mark>is only allowed when the car is stationary and by the use of a tool, and in accordance with the Sporting Regulation and</mark> must:
...
* iv. conform with all bodywork regulations except for Article C3.2.4 (b), Article C3.10.11 (g) (i) and sub-clauses (b) to (l) of Article C3.10.1.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 37
...
* ii. not exceed the size necessary to allow 20mm of overlap between their adjustable and non-adjustable parts, throughout the range of deviation defined in C3.10.10 (l).
...
ii. intersect both Front Wing Profiles and one of Nose, or FW SLM Mid Fairing.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.10 Front Wing (FW) > C3.10.12
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 38
...
to any part of the section visible from below, must not form an angle greater than 10 degrees when measured against the X-axis.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.11 Rear Wing (RW) > C3.11.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 39
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.11 Rear Wing (RW) > C3.11.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 39
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.11 Rear Wing (RW) > C3.11.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 40
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.11 Rear Wing (RW) > C3.11.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 40
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.11 Rear Wing (RW) > C3.11.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 40
...
i. a **“Corner Mode”** position, that exactly conforms to the position of Rear Wing Profiles defined in Article C3.11.1 and that remains identical following any Straight Mode operation to its position beforehand.

ii. a **“Straight Mode”** position that, when compared to the Corner Mode position, results in a decrease in incidence of RW Flap. Furthermore, the magnitude of decrease must always remain identical.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.11 Rear Wing (RW) > C3.11.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 42
...
c. A single **“Rear Wing  Adjuster Fairing”**, across both sides of the car, which must lie in its entirety within RV-RW--FAIRING.
...
f. a Fillet Radius no greater than 10mm, may be applied along the intersection between Rear Wing  Adjuster Fairing and Rear Wing Assembly. Fillet Radii, no greater than 4mm, may be applied along all remaining intersections with Rear Wing Assembly.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.11 Rear Wing (RW) > C3.11.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 42
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.12 Final Assembly > C3.12.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 43
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.12 Final Assembly > C3.12.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 43
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.12 Final Assembly > C3.12.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 43
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.12 Final Assembly > C3.12.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 43
...
b. except for Front Wing Pylon, FW  Linkage and FW  CL Fairing, no part of Front Wing Bodywork may intersect Nose bodywork.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.12 Final Assembly > C3.12.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 43
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.13 Bodywork not defined in Articles C3.5 to C3.12 > C3.13.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 43
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.13 Bodywork not defined in Articles C3.5 to C3.12 > C3.13.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 44
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.13 Bodywork not defined in Articles C3.5 to C3.12 > C3.13.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 44
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.13 Bodywork not defined in Articles C3.5 to C3.12 > C3.13.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 44
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.13 Bodywork not defined in Articles C3.5 to C3.12 > C3.13.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 44
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.14 Wheel Components > C3.14.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 45
...
b. Drum Bodywork must be fitted with an Aerodynamic Seal, in the outboard of the two annotated volumes, between the Drum and the axle. This Aerodynamic Seal must be circumferential, continuous (around an arc of 360°), concentric about the Y<sub>W</sub> axis, and uniform.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.14 Wheel Components > C3.14.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 45
...
b. have up to two sections in any X<sub>W</sub> and Y<sub>W</sub>-Plane.
...
e. Rear Lip Bodywork must have up to two sections in any Z<sub>W</sub>-Plane below Z<sub>W</sub> = -170.
...
j. compliance with (g) and (h) is not required on the Rear Lip within a single transition between one and two Z<sub>W</sub> sections that is contained within two Z<sub>W</sub>-Planes up to 10mm apart.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.14 Wheel Components > C3.14.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 45
...
Furthermore, Rear Scoop Bodywork rearwards of X<sub>W</sub> = 0:
...
d. contain no radius of curvature less than 20mm, except for regions of the Rear Scoop rearwards of X<sub>W</sub> = 0.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.14 Wheel Components > C3.14.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 46
...
b. have up to two sections in any X<sub>W</sub>, Y<sub>W</sub> and Z<sub>W</sub>-Plane below Z<sub>W</sub> = −170.

c. in any Z<sub>W</sub>-Plane:

* i. <mark>the rearmost section must contain at least two points 50mm apart.</mark>
* ii. within 50mm of the rearmost point of the section, a line tangent to any part of the section visible from inboard must not form an angle greater than 5 degrees when measured against the X<sub>W</sub>-axis.
...
f. compliance with (e) is not required within a single transition between one and two Z<sub>W</sub> sections that is contained within two Z<sub>W</sub>-Planes up to 10mm apart.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.14 Wheel Components > C3.14.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 46
...
* i. within an axis aligned cuboid of the following dimensions \[X<sub>W</sub>, Y<sub>W</sub>, Z<sub>W</sub>] = \[150, 45, 25], which may be freely translated along any axis, and rotated about the Y<sub>W</sub> axis only.
* ii. below Z<sub>W</sub> = 0.

b. comprise of up to two, non-intersecting, simply connected volumes.

c. have up to two sections in any X<sub>W</sub>, Y<sub>W</sub> or Z<sub>W</sub>-Plane.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.14 Wheel Components > C3.14.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 46
...
<mark>Front Drum Rear Deflector Bodywork must:</mark> <mark>c. be no more than 15mm thick (being the minimum distance when measured normal to the surface), if visible from inboard.</mark> <mark>Furthermore:</mark> <mark>d. Compliance with (c) is not required within 5mm of the side-view boundary of **Front Drum Rear Deflector** when viewed from inboard.</mark>

Front Drum Rear Deflector Aerodynamic Surfaces must:
e. in any $X_W$-Plane forward of $X_W = 150$, contain no concave radius of curvature:
i. less than 75mm visible from outboard.
ii. visible from inboard.
f. in any $X_W$-Plane rearward of $X_W = 150$, contain no concave radius of curvature less than 50mm.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.14 Wheel Components > C3.14.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 47
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.14 Wheel Components > C3.14.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 48
...
* iv. in any Y<sub>W</sub>-Plane, have at least one axis of symmetry where the larger one will be called the ‘major axis’.
* v. in any Y<sub>W</sub>-Plane, have no dimension which exceeds 2mm larger than the major axis.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.15 Wheel Bodywork Assembly > C3.15.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 48
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.15 Wheel Bodywork Assembly > C3.15.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 48
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.15 Wheel Bodywork Assembly > C3.15.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 49
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.15 Wheel Bodywork Assembly > C3.15.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 49
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.15 Wheel Bodywork Assembly > C3.15.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 49
...
a. pass through the plane Y<sub>W</sub> = -50, except for ducts that cool electrical components.
...
h. except for <mark>regions of zero or incidental flows</mark>, which the FIA may request be demonstrated, only result in flux through the Aperture in the stated direction, when considered relative to the Bodywork. Furthermore, if no direction is stated, the flux direction will not be assessed.



||(c)|(a.i) / (a.iii)|(d)|(e)|(f)|(h)|
|-|-|-|-|-|-|-|
|C3.16.1<br/>Nose|Nose|\[15, 40, 20]<br/>\[0°, ±10°, 0°]|750|Front|i. Must lie in its entirety forward of<br/>XF = −1100.|Influx|
|C3.16.2<br/>Driver<br/>Cooling|Driver<br/>Cooling|\[20, 100, 20]<br/>\[0°, ±10°, 0°]|1500|Front||Influx|
|C3.16.3<br/>FW SLM<br/>Actuator|Front<br/>Wing<br/>Bodywork<br/>or Nose|\[30, 30,<br/>120]<br/>\[±10°,<br/>±25°, ±10°]|see<br/>limb. (f)<br/>(i).|None|i. Must not exceed the size necessary to<br/>accommodate a 10mm offset of the Swept<br/>Bounding Volume of FW SLM Linkage across<br/>the combined range of deviation defined in<br/>C3.10.10 (l) and (n).<br/>ii. May be fitted with a flexible seal that does<br/>not exceed the minimum size necessary to<br/>fully close the Aperture.<br/>*iii. Up to two instances of this aperture are<br/>permitted.*||
|C3.16.4<br/>FW<br/>Adjuster|Front<br/>Wing<br/>Bodywork<br/>or Nose|\[20, 20, 20]<br/>\[0°, 0°, 0°]|200|None|*i. Up to two instances of this aperture are<br/>permitted.*||
|C3.16.5<br/>FSU IB|Nose and<br/>Forward<br/>Chassis|\[90, 10, 30]<br/>\[0°, ±10°,<br/>±10°]|2500|Side|i. Up to two apertures (one each for<br/>push/pullrod and trackrod) are permitted.<br/>ii. No point on the aperture may be more<br/>than 100mm from any other point.||
|C3.16.6<br/>F-Scoop<br/>Inlet|Front<br/>Scoop|\[50, 125, 200]<br/>\[0°, 0°, 0°]|15,000|None|i. Except for minimal incidental leakage, all<br/>air which enters the Front Scoop Inlet must<br/>exit the Front Scoop Outlet.|Influx|
...
||(c)|(a.i) / (a.iii)|(d)|(e)|(f)|(h)|
|-|-|-|-|-|-|-|
|C3.16.7<br/>F-Scoop<br/>Outlet|Front<br/>Scoop|\[75, 125, 200]<br/>\[0°, 0°, 0°]|15,000|Rear|i. Must lie in its entirety rearward of XW = 100 and above ZW = −50 and no closer than 180mm from the YW axis.<br/>ii. Except for minimal incidental leakage, only air which has entered the Front Scoop Inlet shall exit the Front Scoop Outlet.|Efflux|
|C3.16.8<br/>Floor<br/>Auxiliary|Floor<br/>Bodywork|\[10, 80, 80]<br/>\[0°, ±20°, 0°]|1500|Front|i. Must lie in its entirety above Z = 100 and forward of XF = 950.|Influx|
|C3.16.9<br/>Sidepod<br/>Inlet|Sidepod|\[20, 475, 250]<br/>\[0°, ±80°,<br/>±35°]|80,000|Front|i. Must lie in its entirety above Z = 275.|Influx|
|C3.16.10<br/>Cockpit<br/>Entry|Chassis<br/>Mid|\[850, 200,<br/>200]<br/>\[0°, 0°, 0°]|175,000|Above|i. Visibility must be assessed with the Secondary Roll Structure removed.||
|C3.16.11<br/>EC<br/>Louvre<br/>Cooling|Engine<br/>Cover|RV-BW-APERTURE<br/>\[0°, 0°, 0°]|150,000|None|i. RS-BW-APERTURE must be fully obscured when viewed through the aperture from above.<br/>ii. when viewed from the outside of the car, at any angle perpendicular to the X-Axis, any visible exposed surfaces must lie in their entirety within 50mm of the untrimmed surface.<br/>iii. Must not be translated.|Efflux|
|C3.16.12<br/>EC Y25<br/>Cooling|Engine<br/>Cover|\[1200, 25, 50]<br/>\[0°, ±20°, 0°]|30 000|Above|i. Must lie in its entirety inboard of Y = 25.<br/>ii. After the aperture has been applied, RS-EC must remain fully obscured when viewed from the side.|Efflux|
|C3.16.13<br/>EC<br/>Rocket|Engine<br/>Cover|\[10, 300, 350]<br/>\[0°, 0°, 0°]|100,000|Rear|i. Must lie in its entirety rearward of XR = −55.<br/>ii. May consist of up to two apertures per side of the car, where the total area of both apertures must still respect (d) and both apertures must lie within a single instance of the RV.|Efflux|
|C3.16.14<br/>R-Tyre<br/>Sensor|Floor<br/>Bodywork<br/>or Engine<br/>Cover|\[5, 60, 30]<br/>\[0°, ±75°,<br/>±75°]|1500|None|i. Must be fully obscured from below with Floor Body present.||
|C3.16.15<br/>RSU IB|Engine<br/>Cover|\[200, 50, 140]<br/>\[±90°, 0°,<br/>±90°]|12 000|None|i. A single aperture is permitted for each suspension member and driveshaft provided the suspension member, driveshaft or its respective fairing intersects the Engine Cover Bodywork at Legality Setup.<br/>ii. No point on the aperture may be more than 200mm from any other point.<br/>iii. At Legality Setup the Aperture must enclose any parts of the suspension member or driveshaft or their respective fairings (if fitted) that lie forward of XR = −55.|Efflux|
|C3.16.16<br/>R-Scoop<br/>Inlet|Rear<br/>Scoop|\[50, 100, 175]<br/>\[0°, 0°, 0°]|10,000|None|i. Except for minimal incidental leakage, all air which enters the Rear Scoop Inlet must exit the Rear Scoop Outlet.|Influx|
...
||(c)|(a.i) / (a.iii)|(d)|(e)|(f)|(h)|
|-|-|-|-|-|-|-|
|C3.16.17<br/>R-Scoop Outlet|Rear Scoop|\[150, 100, 175]<br/>\[0°, 0°, 0°]|10,000|Rear|i. Must lie in its entirety rearward of XW = 100 and above ZW = −50.<br/>ii. Except for minimal incidental leakage, only air which has entered the Rear Scoop Inlet shall exit the Rear Scoop Outlet.|Efflux|
|C3.16.18<br/>RIS Outlet|Tail|\[15, 60, 170]<br/>\[0°, 0°, 0°]|3250|Rear|i. The RV must lie with its rearmost face at XDIF = 760, upper edge at Z = 380 and inner edge at Y = 0.<br/>ii. Is exempt from C3.16 (b).|Efflux|
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.17 Suspension and Driveshaft Fairings > C3.17.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 52
...
c. lie entirely ahead of X<sub>R</sub> = 300.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.17 Suspension and Driveshaft Fairings > C3.17.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 52
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.17 Suspension and Driveshaft Fairings > C3.17.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 53
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.17 Suspension and Driveshaft Fairings > C3.17.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 53
...
Furthermore, this fairing must not vary the angle subtended by the major axis of its cross section when taken normal to the legality axis, and the plane Z = 0 by more than ±5deg from that at Legality Setup over the range of suspension movement.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.17 Suspension and Driveshaft Fairings > C3.17.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 53
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.17 Suspension and Driveshaft Fairings > C3.17.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 53
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.17 Suspension and Driveshaft Fairings > C3.17.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 54
...
Further details about the implementation of each test are given in <mark>FIA-F1-DOC-050</mark>.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 55

**C3.18.2** ##  Front Wing Bodywork Flexibility

The flexibility of Front Wing Bodywork will be tested by applying a load of \[0, 0, -1000] N at points $\[X_F, Y, Z] = \[-925, \pm525, 300]$.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 55
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 55
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 56

**C3.18.5** #  Front Floor Flexibility

a. Bodywork flexibility will be tested by applying a load vertically upwards through a gimbled 10mm diameter pad. The load will be applied with the centre of the load pad at 25mm from $\[X_F=500, 0, -10]$. The deflection will be measured along the loading axis and relative to the Survival Cell.

At all times during the test, the load at a given deflection must exceed the load given by straight-line graphs defined by connecting the following coordinates in order:

<mark>With increasing load: (0mm, 0N), (6mm, 6000N) (25mm, 6000N).</mark>

<mark>With decreasing load: (25mm, 6000N), (6.5mm, 6000N), (0.5mm, 0N).</mark> This must be the case whether the deflection is increasing, decreasing, or held constant. The test will have no more than a maximum load of 8000N or a maximum deflection of 15mm (whichever is reached first) unless specifically requested by the FIA to investigate behaviour above these limits.

The load deflection relationship must be strictly monotonic with both increasing and decreasing deflection.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 56
...
The loads will be applied simultaneously at $\[X_R=-525, Y=\pm550]$.

Deflection will be measured relative to the rear scrutineering supports defined in C3.3.4.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 56

**C3.18.7** #  Central Floor Flexibility

Local bodywork flexibility within RV-PLANK will be tested by applying a load vertically upwards through three 10mm diameter pads equispaced on a 45mm pcd centred on one of the holes in RV-PLANK between $X_F=800$ and $X_R$. The pads will have a gimbled interface to the loadcell.
...
At the hole positioned between X<sub>C</sub>=−600 and X<sub>C</sub>=−800, the stiffness must always exceed 3kNmm⁻¹.

The test will be performed to 6kN.

At the hole positioned at the rear of the plank, the stiffness must always exceed 6kNmm⁻¹. The test

will be performed to 10kN. Deflection will be measured relative to the scrutineering supports defined in C3.3.4.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 57

**C3.18.8** #  Floor Board Flexibility

a. The Floor Bodywork may deflect no more than 5mm, when measured along the loading axis, when a 100N vertical load is applied at points \[X<sub>F</sub>, Y] = \[695, ±720].

Loads will be applied using weights. The F1 Team must provide 25mm diameter adapters, centred on the load axis. Bodywork must have holes to allow a 2.3mm diameter rod to pass through. All holes required must be sealed on both upper and lower surfaces whenever the car
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 57
...
centred on the load axis. Bodywork must have holes to allow a 2.3mm diameter rod to pass through. All holes required must be sealed on both upper and lower surfaces whenever the car is on the circuit. Deflection will be measured relative to the RIS.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 57

**C3.18.10** #  Rear Wing Bodywork Flexibility

Bodywork may not deflect more than 6mm along the loading axis and 1.0° in a Y-Plane, when two loads of \[218, 0, −985] N each, are applied simultaneously to the Rear Wing Profiles. The loads will be applied at \[X<sub>R</sub> = 390, ±325, 835]

The loads will be applied through adaptors, supplied by the team, that lie between 275mm and 375mm from Y=0 and between X<sub>R</sub>=150 and X<sub>R</sub> = 500. The upper surface each adaptor must lie at
...
The angular deflection will be measured on the rear wing profiles, at \[X<sub>R</sub>, Y] \[375, ±450] and relative to the RIS. Linear deflection will be measured along axis of the load application and relative to the RIS.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 58
...
The RW Flap may deflect no more than 7mm horizontally when a 500N load is applied horizontally. The load will be applied in the plane Z = 800 at one of three separate points which lie within 50mm

of the car centre plane and 300mm either side of it. The loads will be applied in a rearward direction

using a suitable 25mm wide adaptor which must be supplied by the relevant team. The deflection will be measured along the loading axis and relative to the forward part of the Rear

Wing Mainplane at the same Y-station.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.12
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 58

**C3.18.12** Rear Wing Mainplane Trailing Edge

The forward-most aerofoil element of Rear Wing Profiles may deflect no more than 3mm along the line of load application, when a 200N load is applied normal to the lower surface. The load will be
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.13
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 58
...
measured along the loading axis, when a 50N point load is applied in an inward direction normal to the car centre plane using a spherical 15mm diameter tip at \[X<sub>R</sub>, Z] = \[ <mark>670</mark>, 550]. The deflection will be measured relative to the opposite RWEP at the same X and Z location and in the direction of the load.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.14
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 58
...
The force will be applied using a vacuum cup of 50mm diameter and the deflection will be measured at the outer diameter of the cup and relative to the lower surface of the wing, at the same

X-Station, at least 300mm away.


### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.18 Aerodynamic Component Flexibility > C3.18.15
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 58

**C3.18.15** Additional Diagnostics

To allow the behaviour of Bodywork to be monitored, F1 Teams are required, as determined by the FIA, to apply contrasting markers to Bodywork and may be required to run additional cameras

provided by the FIA. Details and positions of these markers and additional Cameras are given in the document <mark>FIA-F1-DOC-050</mark>.
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.19 Aerodynamic Component construction > C3.19.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 59
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.19 Aerodynamic Component construction > C3.19.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 59
...
### Section C > Article C3: AERODYNAMIC COMPONENTS > C3.19 Aerodynamic Component construction > C3.19.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 59
...
### Section C > Article C4: MASS > C4.3 Ballast > C4.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 60
...
### Section C > Article C4: MASS > C4.3 Ballast > C4.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 61

**C4.3.3** ##  Ballast Ahead of X<sub>A</sub>=0
...
**C4.5.1** The reference Mass of the Driver will be established by the FIA technical delegate in accordance with the procedure defined in <mark>FIA-F1-DOC-035</mark> at the first Competition of the Championship, this reference mass may be amended at any time during the Championship season if deemed necessary by the FIA technical delegate.
...
<mark>During any **LTCS** for which a Heat Hazard has been declared:</mark>

<mark>c. A Heat Hazard Mass Increase of 2kg will be applied.</mark>
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 62
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 62

**C5.1.3** All engines must have six cylinders arranged in a 90° “V” configuration and the normal section of each cylinder must be circular.
All six cylinders must be of equal capacity.


### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 62
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 62
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 62
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 62
...
c. An Insert whose part residing in the cylinder head is wholly contained in a cylinder of external diameter 15 mm coaxial with the axis of the spark plug
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 62
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 62
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63

**C5.1.10** All Power Unit breather fluids may only vent to atmosphere and must pass through a single orifice which is positioned behind X<sub>R</sub>=0, inboard of Y=100 and below Z=400. No breather fluids may re-enter the Power Unit.


### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.12
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.13
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.14
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.15
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.16
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.17
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
### Section C > Article C5: POWER UNIT > C5.1 Engine specification > C5.1.18
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 63
...
Legend: <mark>Engine</mark> – <mark>ERS</mark> – <mark>Other</mark>

```mermaid
graph TD
    subgraph ERS_System [ ]
        direction TB
        ES["**ENERGY STORE (ES)**<br/>Maximum delta SoC **4MJ**<br/>*(Art. C5.2.9)*"]
        
        CUK["***CU-K***"]
        MGUK["Single ***MGU-K***"]
        
        ES -- "Max Power<br/>**350kW**<br/>*(Art. C5.2.7)*" --> CUK
        CUK -- "Max 1000J storage<br/>*(Art. C5. 2.16)*" <--> MGUK
        
        ES -- "Max Power<br/>**350kW**<br/>*(Art. C5. 2.7)*<br/><br/>Max Energy per Lap up<br/>to **9MJ**<br/>from CU-K HV DC Bus<br/>*(Art. C5. 2.10)*" --> CUK
    end

    PCS["**PRESSURE<br/>CHARGING<br/>SYSTEM**"]
    
    ENG["**ENGINE**<br/>*(Art. C5. 1)*<br/>Fuel energy flow may not exceed **3000MJ/h**<br/>*(Art. C5. 2.3)*<br/>Below 10500rpm, the fuel energy flow<br/>must not exceed<br/>**EF (MJ/h) = 0.27 N(rpm) + 165**<br/>*(Art. C5. 2.4)*"]
    
    NES["**Non-ERS<br/>Energy<br/>Stores**<br/>*(Art. C5.2.18)*"]
    
    EA["**ENGINE<br/>ANCILLARIES**<br/>*(Art. C5.11)*"]
    
    OA["**OTHER<br/>ANCILLARIES**"]
    ...
    style ES stroke:#00A651,stroke-width:4px
    style CUK stroke:#00A651,stroke-width:4px
    style MGUK stroke:#00A651,stroke-width:4px
    style ERS_System fill:none,stroke:#00A651,stroke-width:2px,stroke-dasharray: 5 5
    
    style PCS stroke:#FF0000,stroke-width:4px
    style ENG stroke:#FF0000,stroke-width:4px
    style EA stroke:#FF0000,stroke-width:4px
    
    style NES stroke:#0070C0,stroke-width:4px
    style OA stroke:#0070C0,stroke-width:4px
```


### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 65
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 65
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 65
...
<mark>\[Note: Further discussions will take place to fully evaluate the benefits and consequences of art. C5.2.5 and whether modifications are necessary.]</mark>


### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 65

**C5.2.6** When assessing compliance with the above two articles, the fuel mass flow rates measured by the Fuel Flow Meter will be converted in the SECU in fuel energy flow rates using the energy density and the LHV of the fuel as measured by the FIA. The procedure which will be used to determine these values may be found in the document <mark>FIA-F1-DOC-058</mark>.


### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 65
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 65
...
i. <mark>When Overtake is not active:</mark>
...
ii. <mark>When Overtake is active</mark> up to:
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 65
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 65

**C5.2.10** The energy harvested, as measured at the CU-K HV DC Bus, must not exceed a limit of 8.5MJ in each lap, subject to the following additional conditions

i. This limit may be reduced to 8MJ at Competitions where the FIA determines that the maximum possible energy harvested per lap <mark>attributable</mark> under braking and in partial load is no more than 8MJ.
...
iii. Up to 0.5MJ <mark>of</mark> additional energy may be harvested in each lap subject to the conditions specified in Article B7.2.

The vehicle fundamentals used to determine the above limits will be provided in the document <mark>FIA-F1-DOC-034</mark>.


### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 66
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.12
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 66
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.13
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 66
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.14
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 66
...
f. With exception of <mark>ERS Auxiliary Circuit</mark> , electrical energy with an instantaneous power higher than 2W may not flow from CU-K logic or driver boards (usually low voltage parts) into the CU-K power stage (usually HV). This must be guaranteed by design and verifiable by inspection.
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.15
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 67
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.16
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 67
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.17
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 67

**C5.2.17** When the car is on the track the maximum instantaneous electrical power linked to the operation of <mark>ERS Auxiliary Circuit</mark> connected on the ES side of the ES DC Sensor and drawn by the BMS directly from the ES cells must not exceed 50W in total. This must be guaranteed by design and verifiable by inspection.


### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.18
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 67
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.19
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 67
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.20
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 67
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.21
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 67
...
### Section C > Article C5: POWER UNIT > C5.2 Power Unit Energy Flow > C5.2.22
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 67
...
### Section C > Article C5: POWER UNIT > C5.3 Turbo Charger > C5.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 68
...
### Section C > Article C5: POWER UNIT > C5.3 Turbo Charger > C5.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 68
...
### Section C > Article C5: POWER UNIT > C5.3 Turbo Charger > C5.3.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 68
...
### Section C > Article C5: POWER UNIT > C5.3 Turbo Charger > C5.3.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 68
...
### Section C > Article C5: POWER UNIT > C5.3 Turbo Charger > C5.3.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 68
...
### Section C > Article C5: POWER UNIT > C5.3 Turbo Charger > C5.3.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 68
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 68
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69
...
* From 1 June 2026 to 31 December 2026: when the Engine is at ambient temperature as well as when the Engine is at 130degC. Any component, assembly, mechanism, or

integrated arrangement of components that is designed or functions to increase the compression ratio in operating conditions beyond 16.0 is prohibited. The procedure which will be used to assess compliance with this article must be defined by each PU Manufacturer according to the instructions detailed in the document FIA-F1-DOC-042. This procedure must be approved by the FIA Technical Department and included in the PU Manufacturer homologation dossier.
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69

**C5.4.6** The crankshaft main Journal Bearing Diameter, measured on the crankshaft, must be no less than 44.95mm. The main Journal Bearing Width excluding chamfer must be no less than 18.95mm. The surface area of the main journal bearing, calculated using all surfaces within 0.06mm of the

maximum radial thickness must be no less than 2500mm<sup>2</sup>. This will be verified by design. The crankshaft crank pin Journal Bearing Diameter, measured on the crankshaft, must be no less


### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69

**C5.4.7** than 41.95mm. The crank pin bearing width excluding the chamfer must be no less than 17.95mm
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.12
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 69
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.13
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 70
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.14
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 70
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.15
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 70
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.16
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 70
...
### Section C > Article C5: POWER UNIT > C5.4 Power unit geometrical constraints and dimensions > C5.4.17
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 70
...
The six mounting faces of the studs for connection to the Survival Cell must lie at \[X<sub>PU</sub>, Y, Z]=\[0, ±270, 25], \[0, ±360, 270] and \[0, ±190, 440]. All six of these studs must be used.

The four mounting faces of the studs for connection to the Gearbox Case must lie at \[X<sub>PU</sub>, Y, Z]=\[480, ±125, 25] and \[480, ±265, 360]. All four of these studs must be used. Optionally, an additional two studs may be used, provided their coordinates are at \[X<sub>PU</sub>, Y, Z]= \[480, ±150, 140]. A tolerance of +/- 0.2mm will be permitted on all of the above dimensions, all dimensions refer to the centre of the studs. All dimensions in this Article refer to studs fitted symmetrically about the car centre plane.
...
### Section C > Article C5: POWER UNIT > C5.5 Mass and centre of gravity > C5.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 71
...
### Section C > Article C5: POWER UNIT > C5.5 Mass and centre of gravity > C5.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 71
...
### Section C > Article C5: POWER UNIT > C5.5 Mass and centre of gravity > C5.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 71
...
### Section C > Article C5: POWER UNIT > C5.5 Mass and centre of gravity > C5.5.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 71
...
### Section C > Article C5: POWER UNIT > C5.5 Mass and centre of gravity > C5.5.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 71
...
### Section C > Article C5: POWER UNIT > C5.5 Mass and centre of gravity > C5.5.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 71
...
### Section C > Article C5: POWER UNIT > C5.5 Mass and centre of gravity > C5.5.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 72
...
**C5.6.1** With the exception of incidental leakage through joints or cooling ducts in the engine intake air system (either into or out of the system), all air entering the engine must enter the bodywork through a maximum of two inlets which are located on a single X plane between X<sub>C</sub>= −850 and X<sub>R</sub>= −500 and above Z=200.
...
### Section C > Article C5: POWER UNIT > C5.6 Engine intake air > C5.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 72
...
### Section C > Article C5: POWER UNIT > C5.6 Engine intake air > C5.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 72
...
### Section C > Article C5: POWER UNIT > C5.6 Engine intake air > C5.6.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 72
...
### Section C > Article C5: POWER UNIT > C5.7 Variable geometry systems > C5.7.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 72
...
### Section C > Article C5: POWER UNIT > C5.7 Variable geometry systems > C5.7.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 72
...
### Section C > Article C5: POWER UNIT > C5.7 Variable geometry systems > C5.7.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 72
...
### Section C > Article C5: POWER UNIT > C5.8 Exhausts > C5.8.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 73
...
### Section C > Article C5: POWER UNIT > C5.9 Fuel systems > C5.9.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 73
...
### Section C > Article C5: POWER UNIT > C5.9 Fuel systems > C5.9.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 73
...
### Section C > Article C5: POWER UNIT > C5.9 Fuel systems > C5.9.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 73
...
### Section C > Article C5: POWER UNIT > C5.9 Fuel systems > C5.9.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 73
...
### Section C > Article C5: POWER UNIT > C5.9 Fuel systems > C5.9.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 73
...
### Section C > Article C5: POWER UNIT > C5.9 Fuel systems > C5.9.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 73
...
### Section C > Article C5: POWER UNIT > C5.10 Ignition systems > C5.10.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
### Section C > Article C5: POWER UNIT > C5.10 Ignition systems > C5.10.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
### Section C > Article C5: POWER UNIT > C5.11 Ancillaries > C5.11.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
### Section C > Article C5: POWER UNIT > C5.11 Ancillaries > C5.11.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
### Section C > Article C5: POWER UNIT > C5.11 Ancillaries > C5.11.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
### Section C > Article C5: POWER UNIT > C5.12 Power unit torque or power demand > C5.12.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
### Section C > Article C5: POWER UNIT > C5.12 Power unit torque or power demand > C5.12.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
### Section C > Article C5: POWER UNIT > C5.12 Power unit torque or power demand > C5.12.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
### Section C > Article C5: POWER UNIT > C5.12 Power unit torque or power demand > C5.12.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74

**C5.12.5** The driver maximum power demand cannot be increased during any power limited pending or power limited period, except when the <mark></mark> Boost is selected by the driver, or, subject to Article B7.2.1, when a reset of any power reduction is permitted.


### Section C > Article C5: POWER UNIT > C5.12 Power unit torque or power demand > C5.12.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 74
...
a. 50kW in any 1s period at Competitions where the FIA determines that the power limited distance exceeds 3500m. The vehicle fundamentals used for the calculation of the power limited distance may be found in the document <mark>FIA-F1-DOC-034</mark>.
...
### Section C > Article C5: POWER UNIT > C5.12 Power unit torque or power demand > C5.12.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 75
...
* the theoretical MGU-K power resulting from reduction at rates equal to those specified in Article C5.12.6 is negative;
...
### Section C > Article C5: POWER UNIT > C5.12 Power unit torque or power demand > C5.12.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 75
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 75
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 75
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 75
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 75
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 75
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 75
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 76
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 76
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 76
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 76
...
### Section C > Article C5: POWER UNIT > C5.13 Power unit control > C5.13.12
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 76
...
### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 77
...
### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 78

**C5.17.3** All cars must be fitted with two ERS status lights which

* a. Have been supplied by an FIA designated manufacturer and fitted to the car in accordance with the instructions in the document <mark>FIA-F1-DOC-043</mark>.
...
### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 78
...
### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 78
...
### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 78
...
### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 78
...
### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 78
...
### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79

**C5.17.9** The minimum mass for the ES Main Enclosure PU Mass group elements as defined in Appendix C4 is 35.0kg. The procedure which will be used to determine this value may be found in the document <mark>FIA-F1-DOC-105</mark>.


### Section C > Article C5: POWER UNIT > C5.17 Energy Recovery System (ERS) > C5.17.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79
...
### Section C > Article C5: POWER UNIT > C5.18 MGU-K > C5.18.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79
...
### Section C > Article C5: POWER UNIT > C5.18 MGU-K > C5.18.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79

**C5.18.3** All mechanical power to and from the MGU-K must pass through a single shaft to the MGU-K transmission. The connection to the ICE crankshaft must be ahead of X<sub>PU</sub>=100.


### Section C > Article C5: POWER UNIT > C5.18 MGU-K > C5.18.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79
...
### Section C > Article C5: POWER UNIT > C5.18 MGU-K > C5.18.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79
...
### Section C > Article C5: POWER UNIT > C5.18 MGU-K > C5.18.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79
...
### Section C > Article C5: POWER UNIT > C5.18 MGU-K > C5.18.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79
...
### Section C > Article C5: POWER UNIT > C5.18 MGU-K > C5.18.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 79
...
### Section C > Article C5: POWER UNIT > C5.18 MGU-K > C5.18.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 80
...
### Section C > Article C5: POWER UNIT > C5.19 Energy Store > C5.19.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 80
...
### Section C > Article C5: POWER UNIT > C5.19 Energy Store > C5.19.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 80
...
### Section C > Article C5: POWER UNIT > C5.19 Energy Store > C5.19.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 80
...
### Section C > Article C5: POWER UNIT > C5.19 Energy Store > C5.19.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 80
...
### Section C > Article C5: POWER UNIT > C5.19 Energy Store > C5.19.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 80
...
### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 81
...
### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 81
...
### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 81
...
### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 81
...
The contactors must be tested and demonstrated to work in realistic load cases, as described in the document <mark>FIA-F1-DOC-045</mark>.


### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 81
...
### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 82
...
### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 82
...
### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 82
...
### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 82

**C5.20.10** The ES Main Enclosure material(s) must satisfy a minimum fire protection equivalent of UL94 V0 unless the ES Cells are proven to not be susceptible to self-heating phenomenon. A document demonstrating compliance with this article must be included in the PU Manufacturer homologation dossier. Guidance on how to demonstrate that ES Cells aren’t prone to thermal runaway behaviour may be found in the document <mark>FIA-F1-DOC-046</mark>.


### Section C > Article C5: POWER UNIT > C5.20 ES design and installation > C5.20.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 82
...
### Section C > Article C5: POWER UNIT > C5.21 ERS General electrical safety > C5.21.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 82
...
f. Connectors must be IP2X when not connected and IP65 when mated. The compliance concerning the Ingress protection rating must be demonstrated via a test performed by a 3<sup>rd</sup> part laboratory, according to IEC60529 or ISO20653.
...
### Section C > Article C5: POWER UNIT > C5.21 ERS General electrical safety > C5.21.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 83
...
### Section C > Article C5: POWER UNIT > C5.21 ERS General electrical safety > C5.21.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 83
...
### Section C > Article C5: POWER UNIT > C5.21 ERS General electrical safety > C5.21.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 83
...
Any components that require equipotential bonding will be connected to the Car Main Ground and the resistance of potential equalization paths must not exceed 5.0 $\Omega$.

In addition, the resistance measured between any two Exposed Conductive Parts of the high voltage system must not exceed 0.1 $\Omega$.


### Section C > Article C5: POWER UNIT > C5.21 ERS General electrical safety > C5.21.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 84
...
### Section C > Article C5: POWER UNIT > C5.21 ERS General electrical safety > C5.21.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 84
...
Any header tank used on the car must be fitted with an FIA approved pressure relief valve which is set to a maximum of 3.75 barG, details of the relief valve may be found in the document <mark>FIA-F1-DOC-055</mark>. If the car is not fitted with a header tank, an alternative position must be approved by the FIA.


### Section C > Article C5: POWER UNIT > C5.22 Oil and coolant systems and charge air cooling > C5.22.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 84
...
### Section C > Article C5: POWER UNIT > C5.22 Oil and coolant systems and charge air cooling > C5.22.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 84

**C5.22.3** Oil Tank**
All cars must be fitted with a single Oil Tank. Oil, as defined in article C16.1.5, may only be contained by the Oil Tank and associated lines, elements defined in item 47 of Appendix C4, ICE, oil radiators/heat-exchangers, Turbo Charger, MGU-K and MGU-K Mechanical Transmission.


### Section C > Article C5: POWER UNIT > C5.22 Oil and coolant systems and charge air cooling > C5.22.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 84
...
### Section C > Article C5: POWER UNIT > C5.22 Oil and coolant systems and charge air cooling > C5.22.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 84
...
**C6.1.1** The fuel tank must be a single rubber bladder conforming to or exceeding the specifications of FIA Standard FT5−1999, the fitting of foam within the tank however is not mandatory. A list of approved materials may be found in the document <mark>FIA-F1-DOC-036</mark>.


### Section C > Article C6: FUEL SYSTEM > C6.1 Fuel tanks > C6.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 85
...
### Section C > Article C6: FUEL SYSTEM > C6.1 Fuel tanks > C6.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 85
...
### Section C > Article C6: FUEL SYSTEM > C6.1 Fuel tanks > C6.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 85
...
### Section C > Article C6: FUEL SYSTEM > C6.1 Fuel tanks > C6.1.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 85
...
**C6.2.1** The total area of apertures in the fuel bladder must not exceed 35 000mm<sup>2</sup>.
...
### Section C > Article C6: FUEL SYSTEM > C6.2 Fittings and piping > C6.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 86
...
### Section C > Article C6: FUEL SYSTEM > C6.2 Fittings and piping > C6.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 86
...
### Section C > Article C6: FUEL SYSTEM > C6.2 Fittings and piping > C6.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 86
...
### Section C > Article C6: FUEL SYSTEM > C6.2 Fittings and piping > C6.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 86
...
### Section C > Article C6: FUEL SYSTEM > C6.4 Refuelling > C6.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 86

**C6.4.2** The fuel in a car must not be colder than the lower of: ten degrees centigrade below ambient temperature, or ten degrees centigrade, at any time when the car is running after leaving the F1 Team's designated garage area.

The fuel in any rig used to fill the car must not be hotter than the greater of: ten degrees centigrade above ambient temperature, or thirty-five degrees centigrade, at any time.
...
### Section C > Article C6: FUEL SYSTEM > C6.4 Refuelling > C6.4.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 87

**C6.4.3** The use of any device on board the car to decrease the temperature of the fuel is forbidden. <span style="color: magenta">Any system or component that increases the temperature of the fuel by means not inherent to, or exceeding, those arising from the normal operation of the car is prohibited.</span>


### Section C > Article C6: FUEL SYSTEM > C6.4 Refuelling > C6.4.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 87
...
### Section C > Article C6: FUEL SYSTEM > C6.4 Refuelling > C6.4.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 87
...
### Section C > Article C6: FUEL SYSTEM > C6.5 Fuel draining and sampling > C6.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 87
...
### Section C > Article C6: FUEL SYSTEM > C6.6 Fuel System Hydraulic Layout > C6.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 87

**C6.6.2** The primer pump(s) and Fuel Flow Meter are SSC, the High Pressure Fuel Pump and the pressure and temperature sensors are SSPUC; as mandated by the FIA and specified in the following documents <mark>FIA-F1-DOC-003</mark>, <mark>FIA-F1-DOC-017</mark>, <mark>FIA-F1-DOC-018</mark> and <mark>FIA-F1-DOC-019</mark>.


### Section C > Article C6: FUEL SYSTEM > C6.6 Fuel System Hydraulic Layout > C6.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 87

**C6.6.3** All flexible pipes and hoses and their fittings between the primer pump and the High Pressure Fuel Pump are SSC, as mandated by the FIA. The specification and permitted lengths are given in the document <mark>FIA-F1-DOC-013</mark>. Rigid pipes and manifolds and their fittings may be used instead of flexible pipes and hoses up to the inlet of the Fuel Flow Meter. Rigid pipes and manifolds may also be used at the Fuel Flow Meter outlet but only for connection to the optional filter or to support the pressure and temperature sensor. Such rigid pipes and manifolds are classified as OSC.


### Section C > Article C6: FUEL SYSTEM > C6.6 Fuel System Hydraulic Layout > C6.6.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 87
...
```mermaid
graph TD
    subgraph Fuel_Cell [Fuel Cell]
        direction TB
        
        Mandatory_Pressure_Sensor[Mandatory Pressure Sensor<br/>pFuelTank] --- Fuel_Cell_Boundary
        Mandatory_PRV[Mandatory PRV] --- Fuel_Cell_Boundary
        
        subgraph Legend [Standard Supply Components SSC<br/>SSC if flexible hose otherwise OSC<br/>Open Source Components OSC<br/>Listed Team Components LTC]
        end

        FIA_Sample[FIA Sample]
        Optional_Collector_NRV[Optional Collector NRV]
        Optional_Pressure_Sensor[Optional Pressure Sensor<br/>pCollector]
        Optional_Level_Sensor[Optional Level Sensor<br/>VCollector]
        
        subgraph Collector
            NRV1[NRV *] --> Primer_Pump[Primer Pump *]
            NRV2[NRV *] --> Optional_Backup_Primer_Pump[Optional Backup Primer Pump]
            Optional_Filter1[Optional Filter]
            Optional_Filter2[Optional Filter]
            Optional_PRV1[Optional PRV]
            Collector_fill_drain_port[Collector fill/drain port]
            Collector_PRV[Collector PRV]
        end
        
        Optional_damper[Optional damper]
        pT_FFMInlet[p/T FFMInlet]
        Fuel_Flow_Meter[Fuel Flow Meter]
        pT_FFMOutlet[p/T FFMOutlet]
        Optional_Filter3[Optional Filter]
        
        Lift_Pumps[Lift Pump s ] --> Filter_s[Filter s ]
        Optional_PRV_running_bleed[Optional PRV / running bleed]
        Breakaway_valve[Breakaway valve]
    end

    Fuel_Cell_Boundary -.-> High_Pressure_Fuel_Pump[High Pressure Fuel Pump]
    High_Pressure_Fuel_Pump --> To_Injectors[To Injectors]
    
    pT_FuelPrimer[p/T FuelPrimer]
    Optional_Filter4[Optional Filter]
```
...
### Section C > Article C6: FUEL SYSTEM > C6.6 Fuel System Hydraulic Layout > C6.6.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 88
...
### Section C > Article C6: FUEL SYSTEM > C6.6 Fuel System Hydraulic Layout > C6.6.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 88
...
### Section C > Article C7: OIL AND COOLANT SYSTEMS AND CHARGE AIR COOLING > C7.3 Oil and coolant lines > C7.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 90
...
### Section C > Article C7: OIL AND COOLANT SYSTEMS AND CHARGE AIR COOLING > C7.3 Oil and coolant lines > C7.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 90
...
d. The internal cross section of any Heat Exchanger Tube must have an area of at least 10mm², without considering structural stiffening ribs and the internal fins described in point (e) below.
...
### Section C > Article C7: OIL AND COOLANT SYSTEMS AND CHARGE AIR COOLING > C7.4 Heat exchangers > C7.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 90
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.1 Software and electronics inspection > C8.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 91
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.1 Software and electronics inspection > C8.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 91
...
Acceptable solutions to verify the programmed software may be found in the document <mark>FIA-F1-DOC-033</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.1 Software and electronics inspection > C8.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 91
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.1 Software and electronics inspection > C8.1.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 91
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.1 Software and electronics inspection > C8.1.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 91
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.1 Software and electronics inspection > C8.1.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 91
...
Details of the homologation process can be found in the document <mark>FIA-F1-DOC-033</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.1 Software and electronics inspection > C8.1.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 91
...
||2026See Note 1|2027|2028|2029|2030|
|-|-|-|-|-|-|
...
Additional information regarding the FIA Standard ECU software versions and setup may be found in the document <mark>FIA-F1-DOC-033</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.2 Control electronics > C8.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 92

**C8.2.2** All ECUs, control sensors, and actuators will be homologated by the FIA. In addition, non-control sensors or units connected to the FIA Standard ECU must also be homologated. Details of the homologation process may be found in the document <mark>FIA-F1-DOC-033</mark>.
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.2 Control electronics > C8.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 92
...
Additional wiring guidelines may be found in the document <mark>FIA-F1-DOC-033</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.2 Control electronics > C8.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 92
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.2 Control electronics > C8.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 92
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.3 Start systems > C8.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 92
...
standalone equipment using an FIA laptop. The F1 Teams should make a jump battery available at all times during the Competition.

The F1 Teams should transfer the real-time Telemetry data and events on the FIA network as

requested by, and in the format defined by, the FIA. Prior to the Race or Sprint Session, the FIA Standard ECU data logger must be configured in such a way that allows logging of data for at least two hours and fifteen minutes without exceeding the size of the logger memory.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.4 Data acquisition > C8.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 93

**C8.4.2** Any data acquisition system, Telemetry system or associated sensors additional to those provided by the FIA Standard ECU and FIA ADR must be physically separate and electrically isolated from
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.5 Telemetry > C8.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 93
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.5 Telemetry > C8.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 93
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.5 Telemetry > C8.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 93

**C8.5.4** The CCU Antenna must be mounted

a. respecting the requirements of <mark>FIA-F1-DOC-022</mark>.
...
```
i. between planes X<sub>C</sub> = 350 and X<sub>C</sub> = 750.
...
Furthermore, referring to <mark>FIA-F1-DOC-022</mark>, any part of the car (except the CCU Antenna) in the residual region defined below which intersects “Zone A” must be constructed of radio transparent material approved by the FIA designated supplier of the F1 Team Telemetry system:
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.6 Driver inputs and information > C8.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 94
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.6 Driver inputs and information > C8.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 94
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.6 Driver inputs and information > C8.6.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 94
...
The design or installation of any component, surface finish, or feature, the purpose or effect of which allow specific points between the 0% and 100% calibrated references of the accelerator
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.7 Master switch > C8.7.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 95
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.9 Accident analysis > C8.9.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 95
...
i. Behind RV−COCKPIT−DRIVER, between X<sub>C</sub> = −475and X<sub>C</sub> = 100 and below Z=440, with its connectors facing forward,

or

ii. Ahead of RV−COCKPIT−DRIVER, behind X<sub>C</sub> = −1075 and below Z=250, with its connectors facing either forward or rearward.
...
Details of the connections to the FIA ADR may be found in the document <mark>FIA-F1-DOC-038</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.9 Accident analysis > C8.9.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 96
...
d. In order that the entire accelerometer body lies as close as possible to the plane Y=0 and within an axis−aligned cube with an internal diagonal bounded by points \[X<sub>C</sub>, Y, Z] \[−500, −130, 0] and \[−250, 130, 150].

e. In a position which is readily accessible at all times from within the Cockpit when the seat is removed.

Details of the accelerometer may be found in the document <mark>FIA-F1-DOC-028</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.9 Accident analysis > C8.9.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 97
...
The camera must be fitted in accordance with the instructions of the FIA, details of which may be found in the document <mark>FIA-F1-DOC-029</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.9 Accident analysis > C8.9.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 97
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.9 Accident analysis > C8.9.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 97
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.11 FIA Marshalling system > C8.11.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 97

**C8.11.2** ##  Car Positioning Unit

The Car Positioning Unit must be positioned in the forward part of the Survival Cell respecting the requirements of <mark>FIA-F1-DOC-023</mark>.
...
b. They lie entirely within an axis-aligned cuboid with an internal diagonal bounded by points \[X<sub>F</sub> = -1300, -925, -200] and \[X<sub>R</sub> = 1000, 925, 1100].

c. No part of any sensor may lie above a triangular surface with vertices at \[X<sub>C</sub> = -200, 0, 655], \[X<sub>F</sub> = -1300, 1225, 655] and \[X<sub>F</sub> = -1300, -1225, 655].
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.14 Installation of electrical systems or components > C8.14.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 98
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.16 Cameras and camera housings > C8.16.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 99

**C8.16.2** Details concerning the technical specification of all cameras may be found in the document <mark>FIA-F1-DOC-022</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.16 Cameras and camera housings > C8.16.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 99

**C8.16.3** With the exception of the position in the driver’s helmet, camera housings, when used, must be fitted in the same location as cameras, and satisfy all the relevant regulations. They must be identical in size, shape, and mass to the camera in lieu of which they are fitted, and must be supplied by the relevant F1 Team. Details concerning the shape and mass of all camera housings may be found in the document <mark>FIA-F1-DOC-022</mark>.
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.16 Cameras and camera housings > C8.16.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 99
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.16 Cameras and camera housings > C8.16.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 99
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.16 Cameras and camera housings > C8.16.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 100

**C8.16.8** #  Position 3

The camera fitted in position 3 must be mounted in order that its forward−most point is situated between X<sub>C</sub> = 0 and X<sub>C</sub> = 300 and between <mark>Z = 840</mark> and Z = 900. The inner face of the camera should be between Y = 120 and Y = 170.
...
### Section C > Article C8: ELECTRICAL SYSTEMS > C8.16 Cameras and camera housings > C8.16.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 100

**C8.16.9** #  Position 4

The camera fitted in position 4 must be mounted in order that its forward−most point is forward of X<sub>C</sub> = 80.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.16 Cameras and camera housings > C8.16.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 100

**C8.16.10** #  Position 5

The camera fitted in position 5 must be mounted, symmetrically about Y=0, with the lens centre forward of X<sub>C</sub> = −1250 and with its lower surface at an angle no greater than 6° to the plane Z=0. In order to not impinge on its 360deg image, any shrouding or cutout should be no higher than “Shoulder X”, as defined in the document <mark>FIA-F1-DOC-022</mark>.


### Section C > Article C8: ELECTRICAL SYSTEMS > C8.16 Cameras and camera housings > C8.16.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 100
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.1 Fundamental provisions > C9.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 101
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.2 Clutch control > C9.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 101
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.2 Clutch control > C9.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 102
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.2 Clutch control > C9.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 102
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.2 Clutch control > C9.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 102
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.2 Clutch control > C9.2.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 102
...
The axis of any gear-change barrel must be above the axis of the secondary shaft. The distance between the front lateral gear-tooth face of the forward-most forward gear ratio pair and the rear lateral gear-tooth face of the rearward-most forward gear ratio pair must be at least 175mm. The minimum distance must be respected by both the gears on the primary (lay) shaft and the gears on the secondary (main) shaft.

The axis of the final drive (at X<sub>DIF</sub>=0) must be between X<sub>R</sub>= -60 and X<sub>R</sub>=60, between Z=260 and Z=280, and be between 390mm and 450mm behind the front lateral gear-tooth faces of both gears of the forward-most forward gear ratio pair.

The tip diameter of the final drive gear must be at least 205mm.


### Section C > Article C9: TRANSMISSION SYSTEM > C9.5 Gearbox Dimensions > C9.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 104
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.6 Gear ratios > C9.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 104
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.6 Gear ratios > C9.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 104
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.8 Gear changing > C9.8.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 105
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.8 Gear changing > C9.8.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 105
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.8 Gear changing > C9.8.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 105
...
### Section C > Article C9: TRANSMISSION SYSTEM > C9.8 Gear changing > C9.8.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 105
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.2 Sprung suspension > C10.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 107
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.2 Sprung suspension > C10.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 107
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.2 Sprung suspension > C10.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 107
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.2 Sprung suspension > C10.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 107
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.2 Sprung suspension > C10.2.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 107
...
2mm over the range of ±12°, measured between the principal axis of rotation of the front wheel and an X−plane. Compliance must be demonstrated using CAD with the vehicle at Legality Setup, using a rigid set−up wheel of spherical outer surface and diameter 700 mm with its centre point at \[X<sub>W</sub>=0, Y<sub>W</sub>=−168, Z<sub>W</sub>=0].
...
Additionally, the angle subtended between the normal projection of the Z<sub>W</sub> axis onto the Y=0 plane and the Z axis must not vary by more than 1 degree over 10mm of suspension travel with the steering wheel rotation fixed. Compliance must be demonstrated by CAD, using camber values of −3 degrees front and −1 degree rear.


### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.3 Outboard suspension > C10.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 108
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.3 Outboard suspension > C10.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 108
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.3 Outboard suspension > C10.3.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 108
...
a. outboard of Y<sub>W</sub>=0.

b. Above Z<sub>W</sub>= −100 for the front axle and above Z<sub>W</sub>= −40 for the rear axle.
...
d. lie outboard of Y<sub>W</sub>=50.
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.3 Outboard suspension > C10.3.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 110
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.3 Outboard suspension > C10.3.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 110

**C10.3.9** Where any Suspension Member attaches to the Survival Cell behind X<sub>C</sub>=−1580, F1 Teams should provide calculations showing that there would be no damage to the Survival Cell if a load of 1.25 times the compressive failure load of the leg is applied to the mounting, along the axis of the leg.


### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.3 Outboard suspension > C10.3.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 110
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.4 Inboard suspension > C10.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 110
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.4 Inboard suspension > C10.4.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 110
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.5 Steering > C10.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 111
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.5 Steering > C10.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 111
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.5 Steering > C10.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 111
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.5 Steering > C10.5.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 111
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.6 Suspension Uprights > C10.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 112
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.6 Suspension Uprights > C10.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 112
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.7 Wheel rims > C10.7.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 112
...
* i. more than 80mm from the axis Y<sub>W</sub>.

and

* ii. outboard of Y<sub>W</sub>=−36.

and

* iii. inboard of; Y<sub>W</sub>=−302 for the front rim and Y<sub>W</sub>=−388 for the rear rim.

c. Once the revolved solid has been fully defined, material may be :

* i. removed between Y<sub>W</sub>=−210 and Y<sub>W</sub>=−392.5 on the rear wheel and between Y<sub>W</sub>=−188 and Y<sub>W</sub>=−319 on the front wheel. Any new surface created must have no concave radius of curvature smaller than 6mm.

* ii. removed in areas less than 80mm from the axis Y<sub>W</sub>.

iii. added or removed to form features for mounting the inflation valve and TPMS sensors.

iv. removed on the outer flanges, between a radius of 238mm and a radius of 246mm from the axis Y<sub>W</sub> and up to 1mm deep for wheel branding, logo, or part numbers.
...
l. Design guidelines for the Wheel Rims are set out in <mark>FIA-F1-DOC-021</mark>. Any deviation from the guidelines must be agreed with the Tyre Supplier.


### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.7 Wheel rims > C10.7.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 113
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.7 Wheel rims > C10.7.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 113
...
The TPMS sensor must be mounted in accordance with the specification given in the document <mark>FIA-F1-DOC-024</mark>.

Wheel rims and tyre pressure and temperature sensors should be marked according to the corner colouring and labelling scheme defined in the document <mark>FIA-F1-DOC-024</mark>.


### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.7 Wheel rims > C10.7.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 113
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.7 Wheel rims > C10.7.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 114
...
|Item|Article|May enterRV-RIM-F/R-MIN|Additional Restrictions|
|-|-|-|-|
|Wheel Fastener|C10.9.1|Yes||
|Disc and fixings|C10.7.5|No||
|Drive Pegs|-|Yes||
|Wheel Spacers|-|No|Must be equal thickness left<br/>and right on same axle.|
|Inflation Valve|-|Yes||
|Closing Panels|C10.7.2.e|No||
|Balance weights|-|Yes|Only as fitted by Tyre Supplier|
|Standard TPMS Sensor<br/>(Mandatory) and mounting|C10.7.4|Yes||
|Standard Rim Temperature<br/>Sensor (Optional) and<br/>mounting|-|Yes||
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.8 Tyres > C10.8.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 114

**C10.8.2** ###  Tyre specification

Tyre specifications will be determined by the tyre supplier, in agreement with the FIA, data will be divided into data blocks as defined in the document <mark>FIA-F1-DOC-057</mark> and according to the timetable given in that document.
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.8 Tyres > C10.8.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 115
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.8 Tyres > C10.8.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 115
...
If a temperature controllable zone contains more than one temperature sensor, the signals must be arbitrated by software prior to being used in the SISO feedback control loop. Additional software design guidelines may be found in the document <mark>FIA-F1-DOC-032</mark>.

e. At any time during a Competition, the heating system must provide mechanisms to:

i. Log and download an accurate record of the last 96 hours of operations. Information to be logged is defined in the document <mark>FIA-F1-DOC-032</mark> and will include power, and energy consumption.
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.9 Wheel attachment and retention > C10.9.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 116
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.9 Wheel attachment and retention > C10.9.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 116
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.9 Wheel attachment and retention > C10.9.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 116
...
### Section C > Article C10: SUSPENSION, STEERING SYSTEMS, WHEELS AND TYRES > C10.9 Wheel attachment and retention > C10.9.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 116
...
### Section C > Article C11: BRAKE SYSTEM > C11.1 Brake circuits and pressure distribution > C11.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 117
...
### Section C > Article C11: BRAKE SYSTEM > C11.1 Brake circuits and pressure distribution > C11.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 117
...
### Section C > Article C11: BRAKE SYSTEM > C11.1 Brake circuits and pressure distribution > C11.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 117
...
### Section C > Article C11: BRAKE SYSTEM > C11.2 Brake callipers > C11.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 117
...
### Section C > Article C11: BRAKE SYSTEM > C11.2 Brake callipers > C11.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 117
...
### Section C > Article C11: BRAKE SYSTEM > C11.2 Brake callipers > C11.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 117
...
### Section C > Article C11: BRAKE SYSTEM > C11.2 Brake callipers > C11.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 117
...
### Section C > Article C11: BRAKE SYSTEM > C11.3 Brake discs and pads > C11.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 118
...
### Section C > Article C11: BRAKE SYSTEM > C11.3 Brake discs and pads > C11.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 118
...
### Section C > Article C11: BRAKE SYSTEM > C11.3 Brake discs and pads > C11.3.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 118
...
### Section C > Article C11: BRAKE SYSTEM > C11.3 Brake discs and pads > C11.3.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 118
...
### Section C > Article C12: SURVIVAL CELL > C12.1 General Requirements > C12.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 119
...
### Section C > Article C12: SURVIVAL CELL > C12.2 Survival cell specifications > C12.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 119
...
a. No part of the Survival Cell may lie ahead of X<sub>A</sub>=0.

b. No part of the Survival Cell may lie behind X<sub>PU</sub>=0.

c. The minimum dimensions of the Survival Cell between X<sub>A</sub>=0 and X<sub>C</sub>=0 are defined by the union of RV-CH-FRONT-MIN and RV-CH-MID-MIN.

d. The Survival Cell must fully enclose RS-PU-ERS.

e. The maximum dimensions of the Survival Cell between X<sub>A</sub>=0 and X<sub>C</sub>=-875 are defined by the union of RV-CH-FRONT and the portion of RV-FLOOR-BODY that lies forward of X<sub>C</sub>=-875 and inboard of Y=±210.
...
### Section C > Article C12: SURVIVAL CELL > C12.2 Survival cell specifications > C12.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 120
...
### Section C > Article C12: SURVIVAL CELL > C12.2 Survival cell specifications > C12.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 120
...
### Section C > Article C12: SURVIVAL CELL > C12.2 Survival cell specifications > C12.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 121
...
f. Recesses of maximum area 75 000mm2 per side and of maximum depth 1.5mm, within the volume RV-CH-MID-MIN, for the sole purpose of mounting team specified Bodywork components.
...
### Section C > Article C12: SURVIVAL CELL > C12.2 Survival cell specifications > C12.2.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 121
...
### Section C > Article C12: SURVIVAL CELL > C12.2 Survival cell specifications > C12.2.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 122
...
### Section C > Article C12: SURVIVAL CELL > C12.2 Survival cell specifications > C12.2.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 122
...
* i. Longitudinally, behind X<sub>C</sub>=−1630 and ahead of RS−INTSN-LAM−FWD.
...
* i. Longitudinally, ahead of X<sub>C</sub>=−415.
...
The following changes are permitted to the Homologated Laminates. The FIA Technical Delegate must be satisfied that the intrusion resistance of the structure has not been reduced by any modification and that its ability to pass the tests defined in Article C15.5.3 is maintained.
...
### Section C > Article C12: SURVIVAL CELL > C12.4 Roll Structures > C12.4.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 123
...
a. It must have structure at \[X<sub>C</sub>=55, 0, 968].

b. A horizontal section through the structure at Z=950 must enclose an area of at least 6000mm<sup>2</sup>. The cross-sectional area may not be less than 6000mm<sup>2</sup> in any horizontal section below this plane.
...
d. A horizontal section through the structure at Z=910 must enclose an area of at least 10000mm<sup>2</sup>. Furthermore, the section must enclose an axis-aligned square of side 70mm. These requirements must be maintained in any horizontal section below this plane.
...
It must be shown by calculation that this opening is capable of resisting a load of 20kN applied by a strap in an upwards direction, on the ZX plane between +45° and -45° to the Z-axis. In designs where the strap could be threaded in different ways, calculations must be provided for all possibilities.


### Section C > Article C12: SURVIVAL CELL > C12.4 Roll Structures > C12.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 124

**C12.4.2** ##  Secondary Roll Structure (Halo)

The Secondary Roll Structure, which is not considered part of the Survival Cell, must be positioned symmetrically about the car centre plane with its front fixing axis at X<sub>C</sub>= -975 and Z=660. The mounting faces for the rearward fixings must lie on the plane Z=695.
...
### Section C > Article C12: SURVIVAL CELL > C12.5 Cockpit Specification > C12.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 125

**C12.5.4** ##  Internal cockpit volumes

a. With the exception of the steering wheel, pedal assembly, driver’s seat, and any padding that is required by Article C12.6.2, no part of the car may lie within a volume created by sweeping the outer vertical section shown in Drawing 3 of Appendix C3 between X<sub>C</sub>= −850 and X<sub>C</sub>= −1415.

b. With the exception of the steering wheel, steering column, driver’s seat, additional padding complying with Article C12.6.2.e, and pedal assembly, no part of the car may lie within a volume created by sweeping the inner vertical section shown in Drawing 3 of Appendix C3 between X<sub>C</sub>= −850 and X<sub>C</sub>= −1515.
...
### Section C > Article C12: SURVIVAL CELL > C12.5 Cockpit Specification > C12.5.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 126
...
b. Are made from a material which is suitable for the relevant ambient air temperature, details of approved materials and the temperature bands in which they should be used may be found in the document <mark>FIA-F1-DOC-049</mark>.
...
k. Be positioned in order that, forward of X<sub>C</sub>=−150, the distance between the two is no less than 320mm.
...
### Section C > Article C12: SURVIVAL CELL > C12.6 Cockpit Padding > C12.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 128
...
a. Be made from a material described in the document <mark>FIA-F1-DOC-049</mark>.

b. Be no less than 25mm thick over their entire area.

c. Cover the area situated between the plane X<sub>C</sub>=−875 and 100mm behind the face of the rearmost pedal when in the inoperative position.
...
f. Must be enclosed by the union of the Floor Bodywork and the fairing defined in Article C3.5.<mark>14</mark>.d (if fitted), such that no part of the system is in contact with the External Air Stream.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.1 General Principles > C13.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 130
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.1 General Principles > C13.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 130

**C13.1.3** All impact tests must be carried out in accordance with FIA Test Procedure 01/00, in the presence of an FIA technical delegate and by using measuring equipment which has been calibrated to the satisfaction of the FIA technical delegate. The test procedure is detailed in the document <mark>FIA-F1-DOC-002</mark>.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.1 General Principles > C13.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 130

**C13.1.4** For all impact tests, all parts that could materially affect the outcome of the test must be fitted. Parts that would not significantly affect the outcome of the test must not be fitted. A list is given for each test in <mark>FIA-F1-DOC-002-03</mark>.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.1 General Principles > C13.1.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 130
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.1 General Principles > C13.1.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 130
...
d. Have seven M10 x 30mm holes in the outer face arranged in a grid pattern as shown in the diagram below. The test laboratory will then fit a 5mm thick 430mm x 430mm steel plate to these holes using a 5mm washer stack.
...
The specification of the tubes and details of how they should be mounted is given in the document <mark>FIA-F1-DOC-002</mark>.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.3 Roll Structure Testing > C13.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 133
...
A load equivalent 130.1kN vertically downward and 51.6kN longitudinally rearward must be applied at a position \[X<sub>c</sub> -785, 0, 830]. in one of the following two ways:
...
The methodology for the calculations shall be authenticated with data from the physical test prescribed above for the load range from 0kN to 80kN.

The load and displacement shall be recorded along the axis of load application together with the vertical displacement of the three attachments.

During the test, the structure must be attached to the Survival Cell which is supported as described in C13.4.1.

**Lateral Test**

A load equivalent to 104.5kN laterally inward and 93.2kN longitudinally rearward must be applied to the outer surface of the structure at a position \[X<sub>c</sub> -590, 233.5, 810]. in one of following two ways:

a. A physical test to 100% of the test load (140kN); or
b. A physical test to 71% of the test load (100kN) plus detailed calculations to show that the

attachments are able to sustain more than 120%of the test load (168kN) when fitted with the secondary structure as specified in Article C12.4.2 and with the deformation simulated as

elastic. The methodology for the calculations shall be authenticated with data from the physical test prescribed above for the load range from 0kN to 50kN. The load and displacement shall be recorded along the axis of load application together with the lateral displacement of the three attachments.

During the test, the Survival Cell should be supported as described in C13.4.1. In addition, the Survival Cell may be restrained laterally and vertically at its front end by a cradle that wraps around all four sides of the Survival Cell. This cradle may extend as far forward as the plane X<sub>A</sub>=0, but may not extend further rearwards than X<sub>A</sub>=600.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.3 Roll Structure Testing > C13.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 134

**C13.3.3** #

In addition to the static load tests described above, each team must supply detailed calculations which clearly show that:
...
ii. a cradle beside the Survival Cell which may extend from X<sub>A</sub>=0 to X<sub>PU</sub>=0. The cradle must not contact the Survival Cell above Z=645.

iii. the engine mounting points.

iv. the FIS mountings.

v. front and rear secondary roll structure mounts. In addition to, or alternative to, the support given by the forward mount, support may be given by a pad on the top surface of the survival cell extending from X<sub>C</sub>=−1300 to X<sub>C</sub>=-850 and above Z=540.
...
|Test|Test|i.CradleBeneath|ii.LateralCradle|iii.PUMounts|iv.FISMounts|v.Sec. roll-Structuremounts|
|-|-|-|-|-|-|-|
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.4 Survival Cell Load Tests > C13.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 135

**C13.4.2** ###  Survival cell fuel tank side test

A pad of diameter 225mm, which conforms to the shape of the Survival Cell, must be placed against the outermost side of the Survival Cell with the centre of the pad positioned at \[X<sub>C</sub>, Z] = \[100, 300].
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.4 Survival Cell Load Tests > C13.4.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 136

**C13.4.3** #  Survival cell wheel contact side test

A pad 200mm in diameter which conforms to the shape of the Survival Cell, must be placed against the outermost side of the Survival Cell. The centre of this pad must lie at X<sub>C</sub> = −1195 and in the Z−direction, at the mid−point of the height of the structure at that section.

Deflections will be measured across the inside of the Survival Cell along the axis of load application. A constant transverse horizontal load of 100kN will be applied to the pad and, under the load, there

must be no structural failure of the inner or outer surfaces of the Survival Cell and the total deflection must not exceed 15mm.

Permanent deformation must be less than 3mm after the load has been released for 1 minute.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.4 Survival Cell Load Tests > C13.4.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 136
...
Under the load, there must be no structural failure of the inner or outer surfaces of the Survival Cell. Permanent deformation must be less than 1.0mm after the load has been released for 1 minute.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.4 Survival Cell Load Tests > C13.4.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 136

**C13.4.5** #  Cockpit floor test

A pad of 200mm diameter must be placed beneath the Survival Cell, at \[X<sub>C</sub>,Y]=\[−600,0], and a vertical upwards load of 75kN applied.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.4 Survival Cell Load Tests > C13.4.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 136
...
**C13.4.6** A pad of 50mm in diameter, must be placed on the side of the cockpit rim with its upper edge at the same height as the top of the cockpit side with its centre at X<sub>C</sub>= −250.

A constant transverse horizontal load of 50kN will then be applied at 90° to the plane Y=0 and, under the load, deformation must be less than 10mm when measured along the loading axis and there

must be no structural failure of the inner or outer surfaces of the Survival Cell. Permanent deformation must be less than 1.0mm after the load has been released for 1 minute.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.4 Survival Cell Load Tests > C13.4.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 136

**C13.4.7** #  Cockpit Side Test

A 225mm diameter pad which conforms to the shape of the Survival Cell at the load application point, must be placed against the outermost sides of the Survival Cell, centred at one of the positions \[X<sub>C</sub>,Z];
...
The position for the reference Survival Cell will be chosen at random and communicated to the F1 Team 3 weeks before their scheduled test date. Subsequent Survival Cells will be tested in the same position. A load of 300kN shall be applied at no more than 15° to the Y-Axis through a ball joint and, under the load, there must be no structural failure of the inner or outer surfaces of the Survival Cell and

the total deflection must not exceed 30mm. The load and displacement shall be recorded along the axis of load application.

After 5 seconds of application, there must be no failure of the Survival Cell. The chassis support conditions shall be the same as those for the lateral test in Article C13.3.2., but the chassis may be mounted in any orientation, provided that the supports do not increase the

strength of the Survival Cell in this load case, beyond the Article C13.3.2 arrangement. A temporary spacer with a maximum diameter of 275mm and a maximum thickness of 6mm may be placed between the pad and the Survival Cell. The spacer must be composite with a quasi-
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.4 Survival Cell Load Tests > C13.4.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 137
...
A dummy front impact structure may be used for this test. The 250mm of the dummy structure closest to the Survival Cell should be identical in design and construction to the structure used in C13.6.2. The dummy structure should not in any way increase the strength of the Survival Cell or of the attachment between the Survival Cell and the impact structure. A constant transversal horizontal load of 92kN must be applied to one side of the impact structure

at X<sub>A</sub>= −600 and at the mid−point of the height of the structure used in C13.6.2. All loads must be applied through a ball−jointed junction at the centre of area of the pad. After 30 seconds of application, there must be no failure of the Survival Cell or of any attachment between the structure and the Survival Cell.

Additionally, teams must supply calculations that show that there would be no failure of the Survival Cell or of any attachment between the structure and the Survival Cell if a load of 110kN were applied X<sub>A</sub>= −600 through the dummy structure.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.4 Survival Cell Load Tests > C13.4.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 137
...
a. On the plane Y=0.
b. In a position between the front of the Survival Cell and $X_C=−1600$, determined by the technical delegate and communicated to the team two weeks before the homologation.
...
a. The construction and geometry of the structures may be found in the document <mark>FIA-F1-DOC-108</mark>.

b. The structures must be mounted with the principal axes of their prismatic mounting sections perpendicular to the plane Y=0. The structures may be rotated ±10° about an axis normal to Y=0 which passes through the centre of area of their outermost longitudinal vertical cross section.

The centres of area of their outermost longitudinal vertical cross sections must be positioned:

i. Longitudinally: between $X_C= -500$ and $X_C= -375$ for the upper structure and between $X_C= -525$ and $X_C= -425$ for the lower structure.

ii. Vertically: between Z=400 and Z=550 for the upper structure and between Z=75 and Z= 100 for the lower structure.

iii. Laterally: Within 15mm of each other.

Refer to the drawings which may be found in the document <mark>FIA-F1-DOC-108</mark>.
...
No parts which, in the opinion of the FIA technical delegate, would prevent proper function of the impact structures in the event of a lateral impact may be present in the volume lying between X<sub>C</sub>= −700 and X<sub>C</sub>= −300, and between Z=50 and Z=600, and outboard of a plane 280mm inboard of the outermost longitudinal vertical cross section of the inboard most impact structure.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.5 Side Impact Structure > C13.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 140
...
respectively in a rearward direction through ball-jointed pads, which may conform to the shape of the structures, measuring 100mm high x 100mm wide and whose centre of area lies 100mm inboard of the centre of the outermost longitudinal vertical cross-section of the impact structure.
b. Horizontal loads of 40kN and 60kN applied simultaneously to the upper and lower structures

respectively in a forward direction through ball-jointed pads, which may conform to the shape of the structures, measuring 100mm high x 100mm wide and whose centre of area lies 100mm inboard of the centre of the outermost longitudinal vertical cross-section of the impact structure.
c. A vertical load of 35kN applied in an upward direction to the lower impact structure through a ball-jointed pad, which may conform to the shape of the structure, measuring 200mm long x

100mm wide whose centre of area lies 100mm inboard of the centre of the outermost longitudinal vertical cross section of the impact structure.
...
x 100mm wide whose centre of area lies 100mm inboard of the centre of the outermost longitudinal vertical cross section of the impact structure.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.5 Side Impact Structure > C13.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 141
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.5 Side Impact Structure > C13.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 141
...
Excluding fairings or any bodywork defined as Front Wing Assembly; Between X<sub>FIS</sub> = 50 and X<sub>A</sub> = −100, the intersection of the FIS with an X−plane must create a single cross section where:

a. The height, width and enclosed area must increase monotonically with increasing X distance.
b. At X<sub>FIS</sub>=50, the enclosed area must exceed 9 000mm² and must enclose a rectangle 120mm wide by 65mm high.

c. At X<sub>FIS</sub>=150, the enclosed area must exceed 20 000mm².

d. Between X<sub>A</sub>=−400 and X<sub>A</sub>=−100, the enclosed area must exceed a value given by a linear taper between 45 000mm² and 60 000mm² respectively.

e. Ahead of X<sub>FIS</sub>=50, no part may lie above Z=235.

f. Behind X<sub>FIS</sub>=50, no part may lie above a plane that is normal to Y=0 and contains points \[X<sub>FIS</sub>, Z]; \[50, 235] and \[150, 305].

g. Behind X<sub>FIS</sub>=250, with the exception of bodywork joggles, any normal to the external surface of the Impact structure must not subtend an angle greater than 25° to an X−plane.

h. All lines drawn normally and externally to a cross−section taken at X<sub>A</sub>= −100 must not cross the plane Y=0.

Once the requirements of (a) to (h) have been met, minimal apertures may be applied for mechanical components or sensors.

Any bodywork ahead of the plane defined in (f), above Z=235, and less than 166mm from the centre plane must be constructed of laminate with an areal weight of reinforcing, no greater than 800gm<sup>−2</sup> with optional aramid or foam core.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.6 Front Impact Structure > C13.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 142
...
i. One will be subject to push-off tests described in Articles C13.6.3.a and C13.6.3.b followed by the dynamic test described in Article C13.6.5.

and

ii. The second will be subject to push-off test described in Articles C13.6.3.c followed by the dynamic test described in Article C13.6.6.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.6 Front Impact Structure > C13.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 143
...
A constant transversal horizontal load of 92kN must then be applied to one side of the FIS at X<sub>A</sub>= -600 and at the mid-height of the FIS at this plane.

The load must be applied through a ball-joint, using a pad measuring 200mm in X, positioned symmetrically about X<sub>A</sub>=-600. The stiffness of the pad may be chosen by the team. Rubber or

foam may be used between the pad and the test structure. The centre of area of the pad must pass through the plane mentioned above and the mid-point of the height of the structure at the relevant section. After 30 seconds of application, there
...
Two equal loads, each equivalent to 3.2kN vertically downward and 2.2kN longitudinally rearward, must be applied simultaneously to the wing section at Y=±250mm. The load vector should intersect the top surface of the wing section between 75mm and 200mm behind the leading edge of the forward wing element, measured in the X-direction.
...
A transversal horizontal load must then be applied to one side of the FIS at X<sub>A</sub>= -900 and at the mid-height of the Front Impact Structure at this plane.

The load must be applied through a ball-joint, using a pad measuring 200mm in X, positioned symmetrically about X<sub>A</sub>=-900. The stiffness of the pad may be chosen by the team. Rubber or

foam may be used between the pad and the test structure. The load must be increased to failure, defined as the point where the load supported by the structure has fallen to 50% of the maximum load reached and an area of failure is apparent.

Failure should occur at a load greater than 52.5kN and the failure must be behind X<sub>A</sub>=-650.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.6 Front Impact Structure > C13.6.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 143
...
The total mass of the trolley and test structure shall be 900kg (+1%/−0). The resistance of the test structure must be such that during the impact:

a. The deceleration profile measured in g from the first deformation of the complete assembly to X<sub>A</sub>=−382 does not exceed the limit curve defined by 13.5/ X<sup>1.13</sup>, where X is the longitudinal distance from X<sub>A</sub>=0, calculated by the test laboratory in metres.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.6 Front Impact Structure > C13.6.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 144
...
a. The impact velocity must exceed 17ms<sup>−1</sup>
...
* ii. Electrical systems with an individual assembly density of no more than 1500kg/m³
* iii. Composite internal bodywork panels with a wall thickness less than 1.5mm.
* iv. Parts of the  SEM adjustment system.
...
### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.6 Front Impact Structure > C13.6.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 145

**C13.6.6** #  Front Impact Structure Dynamic Test 2

This test may only be carried out on the FIS which was subjected to the test described in Article C13.6.3 (c). An F1 Team may trim material from the FIS before this test. Any trim should be to an X-Plane at X<sub>A</sub>≥ −650. A chamfer, 10mm long in X may be applied to the cut surface.
...
a. Between X<sub>DIF</sub>=325 and X<sub>DIF</sub>=750, the external geometry of the Rear Impact Structure must conform to RV−TAIL−RIS with a manufacturing tolerance of ±0.5mm.

b. The rearmost face of the structure must be positioned at X<sub>DIF</sub>=750. The upper surface of the structure on Y=0 must lie at Z=372.5. A tolerance of ±2mm will be accepted for manufacturing reasons only.
...
d. No parts which, in the opinion of the FIA technical delegate, would prevent proper function of the impact structure in the event of a rear impact may be present behind X<sub>DIF</sub>= 325.

The Rear Impact structure is classed as TRC.


### Section C > Article C13: SAFETY STRUCTURES AND HOMOLOGATION > C13.7 Rear Impact Structure > C13.7.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 145
...
a. A lateral load of 40kN applied at the mid−height of the structure at X<sub>DIF</sub>=500 applied using a pad measuring 100mm in X and at least 150mm in Z.

b. A load of 40kN vertically upwards applied on the plane Y=0 at X<sub>DIF</sub>=500 applied using a pad measuring 100mm in X and at least 100mm in Y.

c. A load of 40kN vertically downwards applied on the plane Y=0 at X<sub>DIF</sub>=500 applied using a pad measuring 100mm in X and at least 100mm in Y.
...
The object used for this test must be flat, measure 450mm (±3mm) wide by 550mm (±3mm) high and may have a 10mm radius on all edges. Its lower edge must be at Z=0 (±3mm) and must be so arranged to strike the structure vertically and parallel to X<sub>C</sub>=0.
...
The wheel must be mounted on a compliant fixture with the outer flange uppermost and at 13° to horizontal. The compliance of the fixture must be 7.5±0.75mm when a vertical load of 9.8kN is applied to the wheel fixing.

The Wheel nut must be tightened to a torque of at least 500 Nm.
The rim must be fitted with a tyre, inflated to 150 ±10 kPa.

A mass of 75 kg must be dropped onto the highest point of the rim and have a velocity of at least 6ms⁻¹ before contacting the tyre.
...
Details of the equipment, calibration and test procedure are given in <mark>FIA-F1-DOC-002-03</mark>.
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.2 Rear view mirrors > C14.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 149
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.2 Rear view mirrors > C14.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 150
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.3 Rear lights > C14.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 150

**C14.3.2** The first such light must have:
a. Its rear face on an X−Plane and at least 750mm behind X<sub>DIF</sub>=0.
b. The centre of its rear face on Y=0.
c. The centre of its rear face between Z=295 and Z=305.


### Section C > Article C14: SAFETY EQUIPMENT > C14.3 Rear lights > C14.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 150
...
e. Be fitted in accordance with the instructions detailed in the document <mark>FIA-F1-DOC-025</mark>.


### Section C > Article C14: SAFETY EQUIPMENT > C14.3 Rear lights > C14.3.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 151
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.4 Safety Tethers > C14.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 151
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.6 Driver Cooling System > C14.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 152
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.6 Driver Cooling System > C14.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 152

**C14.6.3** Solid CO<sub>2</sub> (dry ice) must not be used in the driver cooling system.


### Section C > Article C14: SAFETY EQUIPMENT > C14.6 Driver Cooling System > C14.6.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 152
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.6 Driver Cooling System > C14.6.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 152
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.6 Driver Cooling System > C14.6.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 152
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.6 Driver Cooling System > C14.6.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 152
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.6 Driver Cooling System > C14.6.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 152
...
### Section C > Article C14: SAFETY EQUIPMENT > C14.6 Driver Cooling System > C14.6.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 153
...
### Section C > Article C15: MATERIALS > C15.1 General Principles > C15.1.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 154
...
### Section C > Article C15: MATERIALS > C15.1 General Principles > C15.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 154
...
### Section C > Article C15: MATERIALS > C15.1 General Principles > C15.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 154
...
### Section C > Article C15: MATERIALS > C15.1 General Principles > C15.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 154

**C15.1.4** No parts of the car may be made from metallic materials that have a specific modulus of elasticity greater than 40 GPa/(g/cm3). Tests to establish conformity will be carried out in accordance with FIA Test Procedure 03/03, <mark>contained in FIA-F1-DOC-114</mark>


### Section C > Article C15: MATERIALS > C15.1 General Principles > C15.1.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 154
...
### Section C > Article C15: MATERIALS > C15.1 General Principles > C15.1.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 154
...
### Section C > Article C15: MATERIALS > C15.1 General Principles > C15.1.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 154
...
### Section C > Article C15: MATERIALS > C15.1 General Principles > C15.1.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 154
...
### Section C > Article C15: MATERIALS > C15.2 Permitted Materials (Components Outside the PU Perimeter) > C15.2.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 155
...
### Section C > Article C15: MATERIALS > C15.2 Permitted Materials (Components Outside the PU Perimeter) > C15.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 156

**C15.2.2** #  Metallic Materials Used for Additive Manufacture

Components produced by additive manufacture can be made from materials in the following list. A full list of applicable standards and criteria for acceptance of metals under the provisions of Article C15.2.5 in this list is given in the document <mark>FIA-F1-DOC-114</mark>.
...
### Section C > Article C15: MATERIALS > C15.2 Permitted Materials (Components Outside the PU Perimeter) > C15.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 156
...
− A nominal tensile strength ≤ 7100 MPa (i.e. up to and including that of Toray T1100 or Mitsubishi MR70)
...
### Section C > Article C15: MATERIALS > C15.2 Permitted Materials (Components Outside the PU Perimeter) > C15.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 157
...
### Section C > Article C15: MATERIALS > C15.3 Specific Prohibitions and Restrictions (Components Outside the PU Perimeter) > C15.3.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 157
...
### Section C > Article C15: MATERIALS > C15.3 Specific Prohibitions and Restrictions (Components Outside the PU Perimeter) > C15.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 157
...
### Section C > Article C15: MATERIALS > C15.3 Specific Prohibitions and Restrictions (Components Outside the PU Perimeter) > C15.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 158
...
### Section C > Article C15: MATERIALS > C15.5 Prescribed and Homologated Laminates (Components Outside the PU Perimeter) > C15.5.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 159
...
### Section C > Article C15: MATERIALS > C15.5 Prescribed and Homologated Laminates (Components Outside the PU Perimeter) > C15.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 159
...
### Section C > Article C15: MATERIALS > C15.5 Prescribed and Homologated Laminates (Components Outside the PU Perimeter) > C15.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 159

**C15.5.3** ##  The homologated laminates used in the Survival Cell are listed below. Representative panels must resist the specified load when it is applied through a rigid pad measuring 100mm x 130mm. Details of the test procedure are given in the document <mark>FIA-F1-DOC-002</mark>.

The panel must be constructed using the same manufacturing process as the survival cell. Sequential stages that would be carried out at the same pressure may be combined. Cure cycles must be the same temperature and duration as those used on the survival cell and must follow the

recommendations of the resin manufacturer. Additional operations that would not be performed during the construction of the survival cell are not permitted.
...
### Section C > Article C15: MATERIALS > C15.6 Materials, processes and construction – General (Components inside the PU Perimeter) > C15.6.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 160
...
### Section C > Article C15: MATERIALS > C15.6 Materials, processes and construction – General (Components inside the PU Perimeter) > C15.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.6 Materials, processes and construction – General (Components inside the PU Perimeter) > C15.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.6 Materials, processes and construction – General (Components inside the PU Perimeter) > C15.6.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.6 Materials, processes and construction – General (Components inside the PU Perimeter) > C15.6.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.6 Materials, processes and construction – General (Components inside the PU Perimeter) > C15.6.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.7 Materials and construction – Components (Components inside the PU Perimeter) > C15.7.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.7 Materials and construction – Components (Components inside the PU Perimeter) > C15.7.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.7 Materials and construction – Components (Components inside the PU Perimeter) > C15.7.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.7 Materials and construction – Components (Components inside the PU Perimeter) > C15.7.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 161
...
### Section C > Article C15: MATERIALS > C15.7 Materials and construction – Components (Components inside the PU Perimeter) > C15.7.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 162
...
### Section C > Article C15: MATERIALS > C15.7 Materials and construction – Components (Components inside the PU Perimeter) > C15.7.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 162
...
### Section C > Article C15: MATERIALS > C15.7 Materials and construction – Components (Components inside the PU Perimeter) > C15.7.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 162
...
### Section C > Article C15: MATERIALS > C15.7 Materials and construction – Components (Components inside the PU Perimeter) > C15.7.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 162
...
iv. Fasteners belonging to and used with Commercially Available Components may be manufactured in any steel, aluminium and copper base materials.
...
### Section C > Article C15: MATERIALS > C15.8 Materials and construction – Pressure charging and exhaust systems (Components inside the PU Perimeter) > C15.8.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 163
...
### Section C > Article C15: MATERIALS > C15.8 Materials and construction – Pressure charging and exhaust systems (Components inside the PU Perimeter) > C15.8.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 163
...
### Section C > Article C15: MATERIALS > C15.8 Materials and construction – Pressure charging and exhaust systems (Components inside the PU Perimeter) > C15.8.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 163
...
### Section C > Article C15: MATERIALS > C15.8 Materials and construction – Pressure charging and exhaust systems (Components inside the PU Perimeter) > C15.8.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 163
...
### Section C > Article C15: MATERIALS > C15.8 Materials and construction – Pressure charging and exhaust systems (Components inside the PU Perimeter) > C15.8.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 163
...
### Section C > Article C15: MATERIALS > C15.8 Materials and construction – Pressure charging and exhaust systems (Components inside the PU Perimeter) > C15.8.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164
...
### Section C > Article C15: MATERIALS > C15.8 Materials and construction – Pressure charging and exhaust systems (Components inside the PU Perimeter) > C15.8.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164
...
### Section C > Article C15: MATERIALS > C15.8 Materials and construction – Pressure charging and exhaust systems (Components inside the PU Perimeter) > C15.8.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164
...
### Section C > Article C15: MATERIALS > C15.9 Materials and construction – and electronic systems (Components inside the PU Perimeter) > C15.9.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164
...
### Section C > Article C15: MATERIALS > C15.9 Materials and construction – and electronic systems (Components inside the PU Perimeter) > C15.9.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164

**C15.9.2** All casings for electronic systems, including break up boxes, with exception of the must be manufactured from polymeric material or aluminium based alloys.


### Section C > Article C15: MATERIALS > C15.9 Materials and construction – and electronic systems (Components inside the PU Perimeter) > C15.9.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164
...
### Section C > Article C15: MATERIALS > C15.9 Materials and construction – and electronic systems (Components inside the PU Perimeter) > C15.9.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164
...
### Section C > Article C15: MATERIALS > C15.9 Materials and construction – and electronic systems (Components inside the PU Perimeter) > C15.9.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164

**C15.9.5** Soft electromagnetic materials used in electrical machines are not subject to Articles C15.6.1 a), b), c) or h) nor to Article C15.6.2. Cobalt concentration is limited to 10% on soft magnetic alloys.

Concentration up to 49% is permitted providing that all end-of-life cobalt is recycled. In addition, any cobalt used must come from an ethical source.


### Section C > Article C15: MATERIALS > C15.9 Materials and construction – and electronic systems (Components inside the PU Perimeter) > C15.9.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164
...
### Section C > Article C15: MATERIALS > C15.9 Materials and construction – and electronic systems (Components inside the PU Perimeter) > C15.9.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 164
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.1 Basic principles > C16.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 165
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.1 Basic principles > C16.1.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 165
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.1 Basic principles > C16.1.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 165
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.1 Basic principles > C16.1.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 166
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.1 Basic principles > C16.1.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 166
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.1 Basic principles > C16.1.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 166
...
|Sensitivity (RON-MON)|||15.0(1)|ISO 5164/ ASTM D2699<br/>ISO 5163/ ASTM D2700|
...
A correction factor of 0.2 for MON and RON shall be subtracted for the calculation of the final result in accordance with EN 228: 2012
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.3 Composition of the fuel > C16.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 167
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.3 Composition of the fuel > C16.3.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 167
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.3 Composition of the fuel > C16.3.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 168
...
* d. The fuel must be shown to be compatible with the fuel bladder and seal materials used by all F1 Teams or PU Manufacturers that will be using the fuel by passing the tests specified in the document <mark>FIA-F1-DOC-052</mark>.


### Section C > Article C16: FUEL AND ENGINE OIL > C16.4 Fuel approval > C16.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 168
...
**C16.5.1** All samples will be taken in accordance with the FIA Formula One fuel sampling procedure, a copy of which may be found in the document <mark>FIA-F1-DOC-051</mark>.


### Section C > Article C16: FUEL AND ENGINE OIL > C16.5 Fuel sampling and testing at a Competition > C16.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 168
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.5 Fuel sampling and testing at a Competition > C16.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 168
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.5 Fuel sampling and testing at a Competition > C16.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 169
...
|Sulfur<br/>(use one listed method)|ASTM D1552<br/>ASTM D2622<br/>ASTM D3120<br/>ASTM D4294<br/>ASTM D4927|
|-|-|
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.8 Composition of the engine oil > C16.8.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 170
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.9 Engine oil approval > C16.9.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 170
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.9 Engine oil approval > C16.9.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 170
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.10 Sampling and testing at a Competition > C16.10.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 170
...
### Section C > Article C16: FUEL AND ENGINE OIL > C16.10 Sampling and testing at a Competition > C16.10.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 171
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 172
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 172
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 172
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 172
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 172
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 173
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 173
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 173
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.1 General Principles > C17.1.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 173
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.2 Listed Team Components (LTC) > C17.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 174
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.2 Listed Team Components (LTC) > C17.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 174
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.2 Listed Team Components (LTC) > C17.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 174
...
Notwithstanding the provisions of this Article, Supplying Power Unit Manufacturers or Supplying Teams of TRCs may carry out the assembly of the components they supply with adjacent LTC components of the Customer Team. In such cases, the Customer Team may provide the minimal assembly information of the LTCs they need to assemble to the Supplying F1 Team or Power Unit Manufacturer. The FIA must approve such a transaction by reference to these regulations and must

be satisfied that it is not used as a means to circumvent the provisions of Article C17.2.


### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.2 Listed Team Components (LTC) > C17.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 175
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.3 Standard Supply Components (SSC) > C17.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 175
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.3 Standard Supply Components (SSC) > C17.3.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 176
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.4 Transferable Components (TRC) and Free Supply Components (FSC) > C17.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 177
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.4 Transferable Components (TRC) and Free Supply Components (FSC) > C17.4.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 177
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.4 Transferable Components (TRC) and Free Supply Components (FSC) > C17.4.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 177
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.4 Transferable Components (TRC) and Free Supply Components (FSC) > C17.4.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 177
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.4 Transferable Components (TRC) and Free Supply Components (FSC) > C17.4.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 177
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.4 Transferable Components (TRC) and Free Supply Components (FSC) > C17.4.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 177
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.4 Transferable Components (TRC) and Free Supply Components (FSC) > C17.4.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 178
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.4 Transferable Components (TRC) and Free Supply Components (FSC) > C17.4.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 178
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 178

**C17.5.2** For all OSC and OSCNT in use by all F1 Teams, the Design Specification must reside on a designated server specified by the FIA, and be accessible by all F1 Teams. Details about the server, access credentials and file naming and format conventions may be found in the document <mark>FIA-F1-DOC-039</mark>.


### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 178

**C17.5.3** Any F1 Team who designs a new OSC or OSCNT, or modifies the Design Specification of a previous OSC or OSCNT, must upload the new Design Specification to the designated server as specified in the document <mark>FIA-F1-DOC-039</mark>.


### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 178
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 178
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 179
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 179
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 179
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 179
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 179
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.5 Open Source Components (OSC and OSCNT) > C17.5.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 179
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.6 Defined Specification Components (DSC) > C17.6.1
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 180

**C17.6.1** “Defined Specification Components”** (DSC) are components produced to a technical specification defined by the FIA.

A DSC must be approved by the FIA, who will ensure compliance with the technical specification and with Article C17.6. Once approved, details of the component will be added to a Technical List contained in the document <mark>FIA-F1-DOC-039</mark>.


### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.6 Defined Specification Components (DSC) > C17.6.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 180
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.6 Defined Specification Components (DSC) > C17.6.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 180
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.6 Defined Specification Components (DSC) > C17.6.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 180
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.6 Defined Specification Components (DSC) > C17.6.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 180
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.6 Defined Specification Components (DSC) > C17.6.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 180
...
### Section C > Article C17: COMPONENTS’ CLASSIFICATION > C17.6 Defined Specification Components (DSC) > C17.6.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 180
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 182
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 182
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 182
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 182
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 182
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 183
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 183
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 183
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.1 General Principles > C18.1.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 183
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.2 Listed Power Unit Components (LPUC) > C18.2.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 184
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.2 Listed Power Unit Components (LPUC) > C18.2.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 184
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.2 Listed Power Unit Components (LPUC) > C18.2.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 184
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.2 Listed Power Unit Components (LPUC) > C18.2.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 184
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.3 Standard Supply Power Unit Components (SSPUC) > C18.3.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 185
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.3 Standard Supply Power Unit Components (SSPUC) > C18.3.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 186

**C18.3.5** The use of an SSPUC is mandatory and the particular function of that SSPUC must not be by-passed, replaced, duplicated or complemented by another PU component. This provision also applies to any TCC. In exceptional circumstances, the FIA may, at its sole discretion authorise the use of alternative PU components.


### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.3 Standard Supply Power Unit Components (SSPUC) > C18.3.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 186
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 186

**C18.4.2** For all OSPUC in use by all PU Manufacturers, the Design Specification must reside on a designated server specified by the FIA and be accessible by all PU Manufacturers. Details of the server, access credentials and file naming and format conventions may be found in the document <mark>FIA-F1-DOC-039</mark>.


### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 186

**C18.4.3** Any PU Manufacturer who designs a new OSPUC or modifies the Design Specification of a previous OSPUC must upload the new Design Specification to the designated server as specified in the document <mark>FIA-F1-DOC-039</mark>.


### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 187
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 187
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.6
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 187
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 187
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 187
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.9
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 187
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.10
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 187
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.4 Open-Source Power Unit Components (OSPUC) > C18.4.11
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 188
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.5 Defined Specification Power Unit Components (DSPUC) > C18.5.2
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 188
...
### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.5 Defined Specification Power Unit Components (DSPUC) > C18.5.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 188

**C18.5.3** The technical specification of a DSPUC (to its required level of detail) is defined by the FIA and communicated to all PU Manufacturers in the documents <mark>FIA-F1-DOC-005</mark> and <mark>FIA-F1-DOC-006</mark>. Changes to the specification for year (N) will be defined by the FIA before 1 January of year (N-2) and will require the consent of at least 50% of the PU Manufacturers registered to compete in year (N). Changes to the specification after that date and before 1 January of year (N-1) will need the consent of at least 75% of the PU Manufacturers registered to compete in year (N).


### Section C > Article C18: POWER UNIT COMPONENTS’ CLASSIFICATION > C18.5 Defined Specification Power Unit Components (DSPUC) > C18.5.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 188
...
**“Unsprung mass”**: All parts of the car composing the sprung suspension external to the sprung mass and/or not entirely supported by the sprung suspension.
...
Double insulation is composed of two layers of insulators with two different failure modes. Those two layers can be tested separately.

**“Electronic Box”**: Unit that contains at least 1 microcontroller.
**“Energy Recovery System” (“ERS”)**: A system that is designed to recover energy from the car, store that energy and make it available to propel the car and, optionally, to drive any Ancillaries and
...
**“External PU Manufacturer”:** means a person or entity (including any corporate or unincorporated body) that (directly or indirectly): (i) was registered to supply Power Units, and has withdrawn for any reason in the previous year or the year preceding that; or (ii) a power unit manufacturer that is undertaking development work to supply Power Units but has not yet registered with the FIA to supply for the Championship.

In case (i) the designation will start at the date of withdrawal and will continue to apply until one calendar year after the 31 December of the year in which the PU Manufacturer has officially withdrawn. For up to one further calendar year subsequently, the FIA may apply this designation to such an entity in respect of certain activities or relationships as it may determine. After the end of this second calendar year the designation will cease to apply in its entirety.
...
“Journal Bearing Width”: (Appendix C3, Drawing 7) The minimum width of the inner bearing surface at its minimum diameter. This excludes any additional bearing shell width resulting from
...
and the MGU-K. It is composed of power modules, DC-link capacitor(s), gate driver board(s), CUK logic board, and may contain other devices that perform functions related to the CU-K operation such as DC bus discharge circuits, sensors, Y-capacitors, housing, and cooling systems.
...
**“Power Unit” (“PU”)**: The internal combustion engine and Turbo Charger, complete with its Ancillaries, the Energy Recovery System and all actuation systems and PU-Control electronics necessary to make them function at all times.
...
<mark>**“Recharge”**: the action of harvesting energy using the ERS-K, for the purpose of increasing the state of charge of the Energy Store.</mark>
...
**“Ceramic Material”**: (e.g. Al₂O₃, SiC, B₄C, Ti₅Si₃, SiO₂, Si₃N₄) – These are inorganic, nonmetallic solids.
...
**“Intermetallic Materials”**: (e.g., TiAl, NiAl, FeAl, Cu₃Au, NiCo) – These are materials where the material is based upon intermetallic phases, i.e. the matrix of the material consists of greater than

50%v/v intermetallic phase(s). An intermetallic phase is a solid solution between two or more metals exhibiting either partly ionic or covalent, or metallic bonding with a long-range order, in a narrow range of composition around the stoichiometric proportion.
...
|RS-FWH-DRUM|FIA-LEG-0141|E|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (front wheel)|
|RS-RWH-DRUM|FIA-LEG-0190|G *(2026 Championship only)* or H|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (rear wheel)|
|RV-F-RIM-MIN|FIA-LEG-0138|D|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (front wheel)|
|RV-R-RIM-MIN|FIA-LEG-0139|D|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (rear wheel)|
|RS-F-RIM-DISC|FIA-LEG-0185|B|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (front wheel)|
|RS-R-RIM-DISC|FIA-LEG-0186|B|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (rear wheel)|
...
|RV-FWH-LIP|FIA-LEG-0171|C|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (front wheel)|
|RV-RWH-LIP|FIA-LEG-0179|C|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (rear wheel)|
|RV-FWH-SCO|FIA-LEG-0172|B|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (front wheel)|
|RV-RWH-SCO|FIA-LEG-0180|A|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (rear wheel)|
|RV-RWH-FDEF|FIA-LEG-0181|C|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (rear wheel)|
|RS-FWH-RDEF|FIA-LEG-0207|C|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (front wheel)|
|RV-FWH-RDEF|FIA-LEG-0208|C|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (front wheel)|
|RV-RWH-STAY|FIA-LEG-0182|C|Positioned at<br/>\[XW, YW, ZW] = \[0, 0, 0] (rear wheel)|
|RV-HALO|FIA-LEG-0237|B|Positioned at \[XC=0, 0, 0]|
|RV-LATERAL-SAFETY-LIGHT|FIA-LEG-0238|B|Positioned at \[XC=0, 0, 0]|
|RV-SKID-FWD|FIA-LEG-0236||Positioned at \[XF=500, 0, 0]|
|RV-SKID-MID|FIA-LEG-0235||Positioned as specified in C3.6.1|
...
**3.1** The Reference Surface RS-PU-FWD-ERS must be positioned with the origin of the model at \[$X_{PU} \le -360, 0, 0$].
...
4.14 On a plane through X<sub>F</sub> = 930, a section whose edges pass through the following \[Y, Z] vertices sequentially:

a. \[350, 175], \[650, 125], \[770, 75].

4.15 Once the section in §4.14 is fully defined, it must be extruded along X to X<sub>F</sub> = 1775.
...
a. \[X<sub>R</sub> = −600, 400, 75], \[X<sub>R</sub> = −335, 760, 250].
...
a. \[X<sub>R</sub> = −600, 550, 75], \[X<sub>R</sub> = −335, 400, 75], \[X<sub>R</sub> = −335, 400, 250].
...
4.20 On a plane through Y=0, a simple, closed polygon whose edges pass through the following \[X<sub>R</sub>, Z] vertices sequentially:
...
a. \[X<sub>R</sub> = −325, 345, 50], \[X<sub>R</sub> = 300, 400, 100].
...
7.1 On a plane through Z = 70, a simple, closed polygon whose edges pass through the following \[X<sub>F</sub>, Y] vertices sequentially:
...
a. \[X<sub>F</sub> = 1350, 730, 200], \[X<sub>F</sub> = 1350, 710, 200], \[X<sub>F</sub> = 1000, 890, 400].
...
a. \[X<sub>F</sub> = 425, 0], \[X<sub>F</sub> = 425, 100], \[X<sub>F</sub> = 1075, 300], \[X<sub>F</sub> = 1200, 300], \[X<sub>F</sub> = 1200, 0], \[X<sub>F</sub> = 425, 0].
...
a. \[X<sub>F</sub> = 1075, 310, 50], \[X<sub>F</sub> = 1225, 600, 150].
...
a. \[X<sub>F</sub>=430, 0], \[X<sub>F</sub>=430, 75], \[X<sub>F</sub>=690, 125], \[X<sub>R</sub>=−1300, 125], \[X<sub>R</sub>=−350, 50], \[X<sub>R</sub>=−350, 0], \[X<sub>F</sub>=430, 0]

11.2 Once the surface in §11.1 is fully defined, a fillet of radius 25mm must be applied at vertex at \[X<sub>F</sub>=430, 75] and a fillet of radius 2000mm must be applied at the vertices at \[X<sub>F</sub>=690, 125] and \[X<sub>R</sub>=−1300, 125].

11.3 Once the surface in §11.2 is fully defined it must be extruded along Z to Z=−10.

11.4 Once the volume in §11.3 is fully defined; a chamfer of 6mm x 100mm must be applied to the lower edge at X<sub>R</sub>=−350 and a chamfer of 6mm x 12mm must be applied to the remaining lower edges.
...
12.1 A cylinder of diameter 11,000mm centred on the Y-Aligned axis \[X<sub>C</sub>, Z] = \[−1000, −4853], extruded between Y = 0, to Y = 400.

12.2 On a plane through Y = 0, a simple, closed polygon whose edges pass through the following \[X, Z] vertices sequentially:

a. \[X<sub>C</sub> = −875, 195], \[X<sub>C</sub> = −875, 645], \[X<sub>F</sub> = −1300, 645], \[X<sub>F</sub> = −1300, 125], \[X<sub>F</sub> = −1000, 125], \[X<sub>C</sub> = −1830, 225], \[X<sub>C</sub> = −875, 195].
...
a. \[X<sub>F</sub> = −1300, 0], \[X<sub>F</sub> = −1300, 150], \[X<sub>C</sub> = −1830, 200], \[X<sub>C</sub> = −1015, 265], \[X<sub>C</sub> = −400, 400], \[X<sub>C</sub> = 75, 400], \[X<sub>C</sub> = 75, 170], \[X<sub>C</sub> = 320, 170], \[X<sub>C</sub> = 320, 0], \[X<sub>F</sub> = −1300, 0].
...
a. RV-NOSE refers to a sub part of RV-BODY-FRONT forward of X<sub>A</sub> = 0.

b. RV-CH-FRONT refers to a sub part of RV-BODY-FRONT between X<sub>A</sub> = 0 and a plane through X<sub>C</sub> = −875.

c. RV-CH-MID refers to a sub part of RV-BODY-FRONT rearwards of a plane through X<sub>C</sub> = −875.
...
**13.1** A volume bounded by X<sub>C</sub>=−2030 and X<sub>C</sub>=−875 that must be symmetrical about Y=0, and when cut with any X plane, the cross section must:

* a. Contain a four-sided section, with two sides parallel to Z.
* b. Have width that varies linearly from 268 at X<sub>C</sub>=−2030 to 380mm at X<sub>C</sub>=−1330 and then linearly to 490mm at X<sub>C</sub>=−875.
* c. Have height at Y=0 that varies linearly from 300 at X<sub>C</sub>=−2030 to 415 at X<sub>C</sub>=−875.
* d. Have the side visible from above, a convex circular arc, with radius varying linearly from R = 400 at X<sub>C</sub>=−2030 to R=2500 at X<sub>C</sub>=−875.
...
* a. \[X<sub>C</sub> = −830, 470], \[X<sub>C</sub> = −730, 470], \[X<sub>C</sub> = −650, 680], \[X<sub>C</sub> = −750, 680], \[X<sub>C</sub> = −830, 470].
...
* a. \[X<sub>A</sub> = 100, 0, 550], \[X<sub>A</sub> = 525, 125, 675].

**15.2** A cylinder of diameter 11 065mm, centred on the Y-Aligned axis \[X<sub>C</sub>, Z] = \[−1000, −4855], extruded between Y = 0, to Y = 125.
...
**16.1** On a plane through Z = 125, a simple, closed polygon whose edges pass through the following \[X<sub>F</sub>, Y] vertices sequentially:
...
a. \[X<sub>F</sub> = 1300, 0], \[X<sub>F</sub> = 1300, 715], \[X<sub>R</sub> = −1500, 715], \[X<sub>R</sub> = −500, 575], \[X<sub>R</sub> = −500, 350], \[X<sub>R</sub> = −50, 300], \[X<sub>R</sub> = −50, 0], \[X<sub>F</sub> = 1300, 0].
...
a. \[X<sub>R</sub> = -500, 350, 50], \[X<sub>R</sub> = -50, 300, 50], \[X<sub>R</sub> = -50, 300, 600].

**17.7** On a plane through Y=0, a simple, closed polygon whose edges pass through the following \[X, Z] vertices sequentially:

a. \[X<sub>R</sub> = -150, 825], \[X<sub>R</sub> = - -900, 950], \[X<sub>C</sub> = 500, 970], \[X<sub>C</sub> = 500, 500], \[X<sub>R</sub> = -50, 500], \[X<sub>R</sub> = -150, 825].
...
a. \[X<sub>C</sub> = 75, 170, 50], \[X<sub>C</sub> = 320, 400, 970].
...
a. A plane passing through the following points \[$X_R, Y, Z$], with all material forward of the plane discarded:

i. \[160, 575, 700], \[375, 575, 250], \[375, 375, 250].

b. A plane passing through the following points \[$X_R, Y, Z$], with all material rearward of the plane discarded:

i. \[750, 575, 625], \[625, 575, 250], \[625, 375, 250].

c. A plane passing through following points \[$X_R, Y, Z$], with all material below the plane discarded:
...
In each row, the fully defined Reference Volume is an axis-aligned cuboid, which has one interior diagonal defined by the listed points. Reference Volumes with multiple pairs of points are comprised of multiple cuboids. Each individual cuboid must first be defined sequentially by the respective pair of points and all cuboids combined to form the single Reference Volume.
...
|6|Mirror Inner Stay|“MIRROR-ISTAY”|a) \[XC = −830, 175, 600]<br/>b) \[XC = −830, 175, 570]|a) \[XC = −730, 500, 665]<br/>b) \[XC = −730, 260, 600]|
...
|11|Front Wing Fairing|“FW-CL-FAIRING”|\[XF = −1025, 0, 60]|\[XF = −700, 25, 300]|
|12|Front Wing Mid|“FW-MID”|\[XF = -1150, 200, 70]|\[XF = -700, 400, 300]|
|13|Front Wing Linkage|“FW-LINKAGE”|\[0, 0, 0]|\[25, 25, 200]|
|14|Rear Wing Brace|“RW-BRACE”|\[XR = 375, 0, 310]|\[XR= 625, 375, 350]|
|15|Rear Wing Separator|“RW-SEPARATOR”|\[0, 0, 0]|\[30, 10, 30]|
|16|Rear Wing Fairing|“RW-FAIRING”|\[XR = 165, 0, 725]|\[XR = 630, 25, 1000]|
...
![Drawing 1: Crankshaft Mass diagram showing the measurement area between the centre of the front and rear main journals.](../parsed/2026_f1_regulations_section_c/images/page_220_image_1_v2.jpg)

![Drawing 2: Camera and Transponder Locations diagram showing various numbered and lettered positions on a Formula 1 car.](../parsed/2026_f1_regulations_section_c/images/page_220_image_2_v2.jpg)

|Drawing 3|!\[FIA Logo]\(page\_221\_image\_1\_v2.jpg)|Cockpit Cross Section Template|
|-|-|-|

![Technical drawing of the Cockpit Cross Section Template showing dimensions for the outer and inner templates, including radii R50, R75, R25, and R50, and linear dimensions 300, 275, 250, and 50.](../parsed/2026_f1_regulations_section_c/images/page_221_image_1_v2.jpg)
...
|Drawing 4|![FIA Logo](../parsed/2026_f1_regulations_section_c/images/page_221_image_2_v2.jpg)|Turbocharger Compressor and Turbine key Dimensions (Article C5.3.5)|
|-|-|-|


\</page_header>

![Technical diagram of a turbocharger compressor and turbine showing key dimensions labeled A, B, C, D, E and detailed views of blade profiles with parameters f, g, h, i, j, k.](../parsed/2026_f1_regulations_section_c/images/page_221_image_2_v2.jpg)

# Drawing 5 | ![FIA Logo](../parsed/2026_f1_regulations_section_c/images/page_222_image_1_v2.jpg) | Cylinder key planes and dimensions

![Technical diagram showing cylinder key planes, including Outboard and Inboard (towards vee) directions, Transverse Plane, Longitudinal Plane, Lateral Plane, Crankshaft Centreline, Cylinder Centreline, Intake Valve Axes, Exhaust Valve Axes, and Injector Axis at 70° +/- 5°. A yellow quadrilateral indicates where the Spark Plug Axis must pass.](../parsed/2026_f1_regulations_section_c/images/page_222_image_1_v2.jpg)

Spark Plug Axis must pass through yellow quadrilateral

# Drawing 6 | ![FIA Logo](../parsed/2026_f1_regulations_section_c/images/page_222_image_1_v2.jpg) | Top deck and deck height definition

![Technical diagram of an engine block cross-section showing the Crankcase, Cylinder Head, Top Deck, and Crank Centerline. It defines the Deck Height as the distance from the Crank Centerline to the Top Deck. A "Sealing feature, if fitted" is also indicated.](../parsed/2026_f1_regulations_section_c/images/page_222_image_1_v2.jpg)



|Drawing 7|![FIA Logo](../parsed/2026_f1_regulations_section_c/images/page_223_image_2_v2.jpg)|Bearing Dimension Definitions (Articles C5.4.6, C5.4.7)|
|-|-|-|


![Diagram showing bearing width and minimum journal diameter definitions.](../parsed/2026_f1_regulations_section_c/images/page_223_image_1_v2.jpg)



|Drawing 8|![FIA Logo](../parsed/2026_f1_regulations_section_c/images/page_223_image_2_v2.jpg)|Additive Manufacture in the Exhaust Assembly (Article C15.8.7)|
|-|-|-|


![Diagram of an exhaust assembly showing ICE and TC components with additive manufacture dimension limits.](../parsed/2026_f1_regulations_section_c/images/page_223_chart_1_v2.jpg)

# Drawing 9 2026 PU ELEMENT MINIMUM MASS LIMITS (for reference only)
...
|2026 PU MASS ALLOWANCES AS WEIGHED|2026 PU MASS ALLOWANCES AS WEIGHED|2026 PU MASS ALLOWANCES AS WEIGHED<br/>ESME Min Mass as weighed|2026 PU MASS ALLOWANCES AS WEIGHED|2026 PU MASS ALLOWANCES AS WEIGHED<br/>MGUK Min Mass as weighed|2026 PU MASS ALLOWANCES AS WEIGHED|2026 PU MASS ALLOWANCES AS WEIGHED<br/>Not weighed|2026 PU MASS ALLOWANCES AS WEIGHED|2026 PU MASS ALLOWANCES AS WEIGHED<br/>ICE Min Mass as weighed|2026 PU MASS ALLOWANCES AS WEIGHED|2026 PU MASS ALLOWANCES AS WEIGHED<br/>TOTAL PU MINIMUM MASS|
|-|-|-|-|-|-|-|-|-|-|-|
...
# Drawing 10 Survival Cell Emergency indicators

![Technical drawing of a Formula 1 survival cell showing the location and specifications for emergency indicators: Clutch Disengagement, Impact Warning Light, and ERS Safety Light.](../parsed/2026_f1_regulations_section_c/images/page_224_image_1_v2.jpg)

**Notes:**

1. The ERS Safety Light, Impact Warning Light and Clutch Disengagement button must be placed on the LHS of the car in the arrangement shown.
2. All 3 items must lie within a 80mm diameter circle.
3. A graphic must be applied as shown, clearly indicating the function and position of each item.
   * Clutch Disengagement in a white sector with a red letter 'N'.
   * Impact Warning Light in a red sector with a white cross.
   * ERS Safety light in a yellow sector with an ISO3864 "High Voltage" symbol.
...
**Column 6, ‘Supply Perimeter’** differentiates those items included in the PU supply within Power Unit Maximum Supply Price described in Appendix A6 Article 1.4.
...
|PU Area|Item No|List of PU functions/systems/components|PU ELEMENT|SEALED PERIMETER|SUPPLY PERIMETER|REFERENCE VOLUME|PU MASS GROUP|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2026|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2027|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2028|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2029|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2030|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>ADUO|COMPONENT CLASSIFICATION|PU-ANC|
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
|ICE ASSEMBLY|1|Main ICE assembly comprising crankcase, cylinder heads (except combustion chamber and ports and injector port machining), crankshaft, camshaft (excluding camshaft lobe profiles), cam drive, cam covers, front and rear covers, valves, finger followers, Internal gear drives, any part which provides a structural connection between the Survival Cell and the gearbox case through the ICE mounting studs.|ICE|INC|INC|ICE|ICE|✓|✘|✘|✘|✘|✓|LPUC||
||2|ICE-mounted water pumps, ICE oil pumps, ICE oil scavenge pumps, any air/oil separator Non-hydraulic actuators (to allow PU to function), ICE-mounted air valve compressors.|ICE|INC|INC|ICE|ICE|✓|✘|✘|✘|✘|✓|LPUC|YES|
||3|Flywheel|ICE|EXC|INC|ICE|ICE|✓|✓|✓|✓|✓|✓|LPUC||
||4|Main ICE assembly comprising combustion chamber surface and pre-chamber detail within cylinder heads, piston, connecting rod, camshaft lobe profiles, intake and exhaust ports, injector port machining, valvegear air spring sub-assemblies.|ICE|INC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC||
||5|ICE intake air system components including Trumpets, Throttle system, Plenum.|ICE|INC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC|YES|
||6|ICE intake air system components, downstream of those included in item 57 and other than those included in item 5|ICE|INC|INC|EXC|ICE|✓|✓|✘|✓|✘|✓|LPUC|YES|
...
|PU Area|Item No|List of PU functions/systems/components|PU ELEMENT|SEALED PERIMETER|SUPPLY PERIMETER|REFERENCE VOLUME|PU MASS GROUP|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2026|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2027|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2028|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2029|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2030|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>ADUO|COMPONENT CLASSIFICATION|PU-ANC|
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
||7|PU mounted fuel system components downstream of the High Pressure Fuel Pump: (e.g., high pressure fuel hoses, fuel rails)|ICE|INC|INC|ICE|ICE|✓|✘|✘|✘|✘|✓|LPUC|YES|
||8|High Pressure Fuel Pump|ICE|INC|INC|ICE|ICE|✓|✘|✘|✘|✘|✘|SSPUC|YES|
||9|ICE Fluid Filters (Oil,Fuel), oil pump PRV mechanism|ICE|EXC|INC|ICE|ICE|✓|✘|✘|✘|✘|✓|LPUC||
||10|Fuel Injectors|ICE|INC|INC|ICE|ICE|✓|✘|✘|✘|✘|✘|SSPUC|YES|
||11|Fuel Injector spray pattern tuning feature|ICE|INC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC||
||12|Knock Sensors|ICE|EXC|INC|ICE|ICE|✓|✘|✘|✘|✘|✘|SSPUC||
||13|Spark Plugs|ICE|EXC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC||
|EXHAUST|14|Engine Exhaust System (including thermal insulation, excluding fasteners and seals)|EXH|INC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC||
||15|Exhaust fasteners and seals|EXH|EXC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC||
|TURBO|16|Turbo Charger - Includes Compressor and Turbine Wheels, Shaft, Bearings, Centre, Compressor and Turbine Housings, Inlet VG Device, compressor inlet|TC|INC|INC|TC|TC and ICE|✓|✓|✘|✓|✘|✓|LPUC||
||17|Turbo Charger mounted electrical components (e.g. wiring looms, non-regulatory sensors)|TC|EXC|INC|TC|TC and ICE|✓|✓|✘|✓|✘|✓|LPUC||
|WG / POP-OFF|18|Wastegate or similar|EXH|INC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC|YES|
||19|Pop-Off Valve or similar|ICE|INC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC|YES|
|PU ELECTRICAL|20|ICE or EXH-mounted electrical components (e.g. wiring looms within legality volume, non-regulatory-sensors, actuators)|ICE|EXC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|LPUC||
||21|Clutch shaft regulatory torque sensor|EXC|EXC|EXC|EXC|EXC|||||||App C6 \[3F]||
||22|PU-mounted regulatory temperature and pressure sensors|ICE or TC or MGU-K|EXC|INC|Linked to PU Element|Linked to PU Element|✓|✘|✘|✘|✘|✘|SSPUC||
...
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
||||or EXH or ES|||||||||||||
||23|Other regulatory PU sensors|EXC|EXC|EXC|EXC|EXC|✓|✓|✘|✓|✘|✘|SSPUC||
||24|Ignition Coils|ICE|EXC|INC|ICE|ICE|✓|✓|✘|✓|✘|✓|DSPUC||
||25|FIA Standard ECU.|EXC|EXC|EXC|EXC|EXC|||||||App C6 \[11S]||
|ERS - MGU-K|26|MGU-K excluding mechanical power transmission components|MGU-K|INC|INC|ERS|MGU-K|✓|✘|✓|✘|✓|✓|LPUC||
||27|ICE mounted MGU-K mechanical power transmission components, housing assembly and mounting accessories|ICE|INC|INC|ICE and/or ERS|ICE|✓|✘|✓|✘|✓|✓|LPUC||
||28|MGU-K mounted MGU-K mechanical power transmission components, housing assembly and mounting accessories|MGU-K|INC|INC|ICE and/or ERS|MGU-K|✓|✘|✓|✘|✓|✓|LPUC||
||29|MGU-K regulatory Torque sensor: Field sensor assembly|MGU-K|EXC|INC|ICE and/or ERS|MGU-K or ICE|✓|✘|✓|✘|✓|✘|SSPUC||
||30|MGU-K torque sensor signal conditioning module (SCM)|MGU-K|EXC|INC|EXC|MGU-K or ICE or ESME|✓|✘|✓|✘|✓|✘|SSPUC||
||31|The MGU-K torque sensor shaft, mounting accessories and the mechanical connection elements between K and ICE, if applicable.|ICE and/or MGU-K|EXC|INC|ICE and/or ERS|MGU-K or ICE|✓|✘|✓|✘|✓|✓|LPUC||
||32|ERS-K phase conductors, associated interfaces and mounting accessories.<br/>MGU-K terminal box|MGU-K|EXC|INC|ERS|MGU-K|✓|✘|✓|✘|✓|✓|LPUC||
||33|MGU-K electrical components fitted outside of sealed perimeter of item 26 (e.g. wiring looms, non-regulatory sensors)|MGU-K|EXC|INC|ERS|MGU-K|✓|✘|✓|✘|✓|✓|LPUC||
|ERS - ES|34|ES Main Enclosure (ESME)|ES|INC|INC|ERS|ESME|✓|✘|✓|✘|✓|✓|LPUC||
...
|PU Area|Item No|List of PU functions/systems/components|PU ELEMENT|SEALED PERIMETER|SUPPLY PERIMETER|REFERENCE VOLUME|PU MASS GROUP|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2026|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2027|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2028|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2029|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2030|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>ADUO|COMPONENT CLASSIFICATION|PU-ANC|
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
||47|Catch tanks, any breather system connected to the PU|ICE|INC|INC|OT and ICE|ICE|✓|✓|x|x|x|✓|LPUC|YES|
...
||57|ICE intake air heat exchangers and their associated accessories (including but not limited to housings, supports, brackets, fasteners, tubes from compressor outlet to heat exchanger, and a maximum of 2 simple and|EXC|EXC|EXC|EXC|EXC|||||||App C6 \[9D or 9E]||
...
|PU Area|Item No|List of PU functions/systems/components|PU ELEMENT|SEALED PERIMETER|SUPPLY PERIMETER|REFERENCE VOLUME|PU MASS GROUP|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2026|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2027|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2028|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2029|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>2030|UPGRADE SCHEDULE (HOMOLOGATION STATUS)<br/>ADUO|COMPONENT CLASSIFICATION|PU-ANC|
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
|INSTALLATION AND MISCELLANEOUS|68|Fuel feed pumps delivering less than 10 barG and their associated accessories (included but not limited to tubes, hoses, supports, brackets, and fasteners).|EXC|EXC|EXC|EXC|EXC|||||||App C6 \[6B]||
||69|Heat Shields and associated mounting hardware.|EXC|EXC|EXC|EXC|EXC|||||||App C6 \[10J]||
||70|PU air valve regulators|ICE|EXC|INC|EXC|ICE|\[x]|\[x]|\[x]|\[x]|\[x]|\[x]|LPUC||
||71|Any ancillary equipment associated with the PU air valve system excluding regulators (e.g., pneumatic bottles, hoses, filling valves).|ICE|EXC|INC|EXC|ICE|\[x]|\[x]|\[x]|\[x]|\[x]|\[x]|LPUC||
...
||77|Boost pressure measurement devices|ICE|EXC|INC|EXC|EXC|\[x]|\[ ]|\[ ]|\[ ]|\[ ]|\[ ]|SSPUC||
||78|Lambda Sensor(s)|EXH|EXC|INC|EXC|EXC|\[x]|\[x]|\[ ]|\[x]|\[ ]|\[x]|DSPUC||
|FLUIDS|79|Fuel|EXC|EXC|EXC|EXC|EXC|\[x]|\[x]|\[ ]|\[x]|\[ ]|\[x]|||
||80|Engine oil|EXC|EXC|EXC|EXC|EXC|\[x]|\[x]|\[ ]|\[x]|\[ ]|\[x]|||
||81|Hydraulic fluid|EXC|EXC|EXC|EXC|EXC|\[x]|\[x]|\[x]|\[x]|\[x]|\[x]|||




|PU Area|Item No|List of PUfunctions/systems/components|PU ELEMENT|SEALED PERIMETER|SUPPLY PERIMETER|REFERENCE VOLUME|PU MASS GROUP|UPGRADE SCHEDULE(HOMOLOGATION STATUS)<br/>2026|UPGRADE SCHEDULE(HOMOLOGATION STATUS)<br/>2027|UPGRADE SCHEDULE(HOMOLOGATION STATUS)<br/>2028|UPGRADE SCHEDULE(HOMOLOGATION STATUS)<br/>2029|UPGRADE SCHEDULE(HOMOLOGATION STATUS)<br/>2030|UPGRADE SCHEDULE(HOMOLOGATION STATUS)<br/>ADUO|COMPONENT CLASSIFICATION|PU-ANC|
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
||82|Engine Coolant|EXC|EXC|EXC|EXC|EXC|✓|✓|✓|✓|✓|✓|||
||83|ERS Fluid|EXC|EXC|EXC|EXC|EXC|✓|✓|✓|✓|✓|✓|||
|BALLAST|84|ICE Ballast<br/>(subject to Article C4.4)|ICE|INC|INC|ICE|ICE|✓|✓|✓|✓|✓|✓|LPUC||


below relates to additional *PU* functions, systems and components not included within the *PU* component definition defined in Table 1 and classifies them as included in or excluded from the Supply Perimeter.
...
**Column 4, ‘Supply Perimeter’** differentiates those items included in the *PU* supply within Power Unit Maximum Supply Price described in Appendix A6 Article 1.4. ‘INC’ is included in the Supply Perimeter and ‘EXC’ is excluded from the Supply Perimeter.
...
|Operational|Item No<br/>85<br/>86<br/>87<br/>88<br/>89<br/>90<br/>91<br/>92<br/>93<br/>94<br/>95|List of PU functions/systems/components<br/>Power Units and spare Power Unit elements, ancillaries and components necessary for use by the F1 Team during:i. All Competitions in the Championship. Minimum number of PU elements, and ancillaries and components per F1 team to be (number of each per driver per season according to Section B of the F1 Regulations) x 2ii. Testing of Current Cars (TCC) in accordance with Section B of the F1 Regulationsiii. DE with a Current Car and PE with a Current Car.A maximum of 8000 km per calendar year will be INC within the PUSP for the activities detailed in 85.ii and 85.iii of the table.<br/>Additional PUs or PU elements, ancillaries and components required to replace units out of service due to accident damage or other cause induced by team will be outside the supply perimeter and will incur additional charges.<br/>All Power Unit Transportation Costs.<br/>Provision of trackside support activities relating to the operation of Power Units by the F1 Team during any Competition and Testing of Current Cars (TCC) undertaken by up to a maximum of 8 people physically present at each Event.<br/>Provision of remote support for Power Unit Activities, related to the operation of Power Units by the F1 Team, during any Competition and Testing of Current Cars (TCC).<br/>Provision of trackside support activities by personnel physically present at the event related to the operation of Power Units by the F1 Team during Events other than Competitions and TCC.<br/>Travel, accommodation, and reasonable expenses for support personnel<br/>Quantity of fuel and oil and other products (i.e hydraulic fluids, cooling fluids...), specified by the PU Manufacturer, necessary for use by the team during Competitions, Tests or Events.<br/>Garage equipment defined as compulsory by Manufacturer (including but not limited to tool sets required for PU trackside support activities, dielectric fluid desorber system, ES offboard (dis)charger).All equipment required to support the activities related to the operation of Power Units not being part of the item #94.<br/>Garage IT equipment, data connection to factory, servers, telemetry, radio, team clothing and all garage equipment identified by the Power Unit manufacturer as not strictly necessary for the operation of the Power Unit<br/>PUTB activities undertaken for the Sole Purpose Of Testing Power Units For Performance And Reliability pursuant to the Operational Regulations.Note that for PUTB activities pursuant to Article F.5.3.2.c. of the Operational Regulations this applies only and exclusively in respect of the bill of materials cost of the Power Unit components installed and being tested.|SUPPLYPERIMETER<br/>INC<br/>EXC<br/>EXC<br/>INC<br/>INC<br/>EXC<br/>EXC<br/>EXC<br/>INC<br/>EXC<br/>INC|
|-|-|-|-|




|Item No|List of PU functions/systems/components|SUPPLYPERIMETER|
|-|-|-|
|96|PUTB activities that are not for the Sole Purpose Of Testing Power Units For Performance And Reliability pursuant to the Operational Regulations.<br/>Note that for PUTB Activities pursuant to Article F.5.3.2.c. of the Operational Regulations this applies to all types of costs incurred in the undertaking of the PUTB activity other than the bill of materials cost of the Power Unit components installed and being tested.|EXC|
...
* d. be submitted and updated according to the procedure detailed in the document <mark>FIA-F1-DOC-047</mark>.
...
**1.6** For parts listed in the document <mark>FIA-F1-DOC-047</mark>, preliminary dossiers must be submitted during the year preceding the year of introduction according to the following dates:

a. before the 21ˢᵗ of March, the ERS Preliminary Dossier including the details justifying all the points mentioned in the article C5.2.14. This will be pre-homologated by the FIA. Any further modification following this pre-homologation must also be submitted to the FIA.

b. before the 1ˢᵗ of November, the Preliminary Dossier for specific parts of the entire Power Unit.
...
The procedure and associated document templates that must be used by the Power Unit Manufacturers for their requests are available in the document <mark>FIA-F1-DOC-047</mark>.
...
For each ICE supplied by the PU Manufacturers, an ICE Performance Index will be calculated. The methodology to calculate this value can be found in the document <mark>FIA-F1-DOC-096</mark>.
...
<mark>\[The proposed 2% threshold and subsequent resolution of the ICE performance index will be validated or adjusted after conclusion of the ongoing activities between PU Manufacturers and F1 Teams related to the on-track ICE performance measurement]</mark>
...
|1H|Rear Impact structure|C13.7.1|TRC|The structure that mounts to the rear of the gearbox behind the differential|Part as bonded to *gearbox carrier Gearbox Case*. Details of flange for Rear Wing Beam attachment, excluding profile details.|Fairings, bolted components|
|1K|Pedals||OSC|Pedal Assembly|Brake pedal assembly including pushrod connecting to the brake master cylinders(s), throttle Pedal including throttle damper, heel−rest, mounting brackets and local electrical and|Fixings to the Survival Cell.|




|1L<br/>1M<br/>1N<br/>2 Aerodynamic Components<br/>2A<br/>2B<br/>2C<br/>2D<br/>2E<br/>2F<br/>2G-F<br/>2G-R<br/>2H-F<br/>2H-R<br/>3 Transmission<br/>3A|Mirror Lens<br/>Side Impact Structures<br/>Halo<br/>2 Aerodynamic Components<br/>Aerodynamic Components, unless otherwise specified<br/>Plank assembly<br/>Rear wing adjuster (M)<br/>Front Wing Adjuster (M)<br/>Rear Wing<br/>Front Wing<br/>Front Drum<br/>Rear Drum<br/>Susp Fairings - Front<br/>Susp Fairings - Rear<br/>3 Transmission<br/>Gearbox Case|C12.2.7<br/>C13.5<br/>C12.4.2<br/>2 Aerodynamic Components<br/>C3<br/>C3.5.9<br/>C3.11.6 3 Transmission<br/>C9.5|OSC<br/>DSC<br/>DSC<br/>2 Aerodynamic Components<br/>LTC<br/>LTC<br/>OSCNT<br/>OSCNT<br/>LTC<br/>LTC<br/>LTC<br/>LTC<br/>LTC<br/>LTC<br/>3 Transmission<br/>TRC|Mirror Lens<br/>Upper & Lower SIS Tubes<br/>Halo, and fixings<br/>2 Aerodynamic Components Plank assembly as defined in 3.5.9<br/>M actuator including linkages 3 Transmission<br/>As defined in Article 9.1.5|electronic components<br/>Mirror Lens<br/>SIS TubesSupply to be agreed before 30 June year N−1<br/>Halo, fwd. pin, rwd. bolts.Supply to be agreed before 30 June year N−1<br/>2 Aerodynamic Components Plank structure and skids<br/>Machined M Actuators, linkages, local electrical and electronic components 3 Transmission<br/>Gearbox Case, associated fastenings, internal heat shieldsFront Cover, Diff Cap, Seals, Fasteners, Cross−shaft Covers|Backing structures<br/>Mounting Brackets<br/>Fwd, mounting bracket, fairings.<br/>2 Aerodynamic Components Hoses, any component rigidly attached to the rear wing flap. 3 Transmission<br/>RIS, Inboard suspension components, Engine mountings|
|-|-|-|-|-|-|-|
...
|4A|Inboard Front Suspension|C10.4|TRC|All parts of the front suspension between the connection to the push / pull rod and the Survival Cell.|Rockers, springs, ARB system, damper, bearings, local electrical and electronic components, ride height adjustment, any brackets which are not integral with the|||




|Component|Article|Code|Category|Description|Survival Cell. A range of set–up options|Additional Components|
|-|-|-|-|-|-|-|
...
|4F|Inboard Rear Suspension|C10.4|TRC|All parts of the rear suspension between the connection to the push / pull rod and the *gearbox carrier Gearbox Case*|Rockers, springs, ARB system, dampers, bearings, local electrical and electronic components, ride height adjustment, any brackets which are not integral with the *gearbox carrier Gearbox Case*. A range of set–up options||




|Component ID|Component Name|Reference|Classification|Structural Members|Wishbones / Links / Components|Suspension Fairings / Fixings|
|-|-|-|-|-|-|-|
|4G|Rear Suspension Members|C10.3|TRC|Structural members connecting the upright to the gearbox case or inboard suspension|Wishbones / Links, Track−rod, Push/pull Rod, Bearings, Inboard Brackets not integrated in the gearbox carrier *Gearbox Case*, Fasteners, Wheel Tethers, local electrical and electronic components.|Suspension Fairings as defined in 3.14|
...
|4R|Tyres|C10.8|SSC||||
|\*\*Brakes\*\*|||||||
|5A|Brake disc, disc Bell, and pad assembly|C11|OSC||Structural brake disk bell transferring torque from the axle to the brake disc, brake disc and pads|Any component bolted on the structural disk bell (i.e. deflectors)|
...
|\*\*Fuel System\*\*|||||||
|6A|Collector|C6.6.4,<br/>C6.6.6|OSC|Collector assembly and pressurisation system if fitted.|Collector assembly including any pressurisation system, any local electrical|Hoses and pipes|




|Item|Reference|Category|Description|Specification|Notes||
|-|-|-|-|-|-|-|
...
|7|Hydraulic System|Hydraulic System|Hydraulic System|Hydraulic System|Hydraulic System|Hydraulic System|
|-|-|-|-|-|-|-|
...
|Item|Description|Article|Supplier|Notes|Materials|Location|
|-|-|-|-|-|-|-|
|10E|High Pressure Fuel Pump|C5.11.6|SSPUC|EMPTY|EMPTY|EMPTY|
|10F|Exhaust System Beyond Turbine and Wastegate Exits|C3.8.2|TRC|Exhaust and wastegate pipes downstream of turbine exit / wastegate exit.|Pipes, clamps|EMPTY|
|10G|Air Filter|EMPTY|FSC|EMPTY|EMPTY|Components inside the Power Unit Supply Perimeter|
|10H|Compressor Inlet Duct|Apx.C4 Table 1 #72|FSC|EMPTY|EMPTY|Components inside the Power Unit Supply Perimeter|
|10J|Engine Heat Shields|Apx.C4 Table 1 #69|FSC|EMPTY|EMPTY|Components inside the Power Unit Supply Perimeter|
|10K|Breather System|Apx.C4 Table 1 #74|LTC|As defined in App.C4|EMPTY|Components inside the Power Unit Supply Perimeter.|
|10L|Compressor Outlet Duct|EMPTY|FSC|Duct from the outlet of the Compressor Housing to the air inlet of a Secondary Heat Exchanger|EMPTY|Components inside the Power Unit Supply Perimeter.<br/>Any duct from Compressor Outlet to a Primary Heat Exchanger|
|11 Electrical Systems Hardware|EMPTY|EMPTY|EMPTY|EMPTY|EMPTY|EMPTY|
|11B|Electrical looms|EMPTY|TRC|Looms interfacing the main chassis electrical system with PU systems, transmission systems and other peripheral control or measurement systems.|Main chassis looms, can be made of separate parts, up to and including the connectors to local PU looms, transmission looms or other local looms for peripheral control or measurement systems.|Looms for test installations linked to Article 8.15.1|
|11C|car to team telemetry|C8.5.1|SSC|EMPTY|EMPTY|EMPTY|
|11D|Driver radio|C8.8|SSC|EMPTY|EMPTY|EMPTY|
|11E|Accident Data Recorder (ADR)|C8.9.1|SSC|EMPTY|EMPTY|EMPTY|
|11F|High speed camera|C8.9.3|SSC|EMPTY|EMPTY|EMPTY|
...
|12C|Driver Cooling System|C14.6|OSC|Driver cooling system up to the connector to the driver's personal equipment.|All components declared under Article 4.6.b.ii|Driver's personal equipment.<br/>Pipe runs between sub-assemblies.|
...
|14E|Overhead Gantry||FSC|Gantry or gantries providing air and|Gantry, air lines, air regulators, cabling.||




|||||electrical connections<br/>to other items of<br/>pitstop equipment.|||
|-|-|-|-|-|-|-|
|14F|Control System||FSC|The system used to control the pit-stop|Sensors, cameras,<br/>“traffic lights”,<br/>associated cabling,<br/>software.||
...
|Gearbox Case & Rear Impact<br/>Structure|Appendix C6 – 3A<br/>Appendix C6 – 1H|
...
**Black Text**: Text unchanged from current Issue of 2026 F1 technical Regulations - Section C <mark>**Pink Text**</mark>: <mark>Changes relative to FIA 2026 F1 Regulations - Section C \[Technical] – approved at the current issue.</mark> <mark>**Purple Text**</mark>: <mark>Changes relative to FIA 2026 F1 Regulations - Section C \[Technical] – approved at a previous issue.</mark>

## Changes Approved for 2027


### Section C > Article C5: .4.15c > None > C5.4.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 256

**C5.4.3** No cylinder, <mark>as referred to by C5.1.3,</mark> of the Engine may have a geometric compression ratio higher than 16.0, <mark>when the Engine is at 130degC.</mark>

The procedure <mark>which will be used to assess compliance with this article must be defined by each PU Manufacturer according to the instructions detailed in the</mark> document <mark>FIA-F1-DOC-042</mark>. <mark>This procedure must be approved by the FIA Technical Department and included in the PU Manufacturer homologation dossier.</mark>

**13.6.2 Front Impact Structure Homologation**

<mark>One FISs must be presented for homologation. By random selection by the FIA on the day of the homologation, this FIS will be subject to either;</mark>

<mark>i. The push-off tests described in Articles C13.6.3.a and C13.6.3.b followed by dynamic test described in Article C13.6.5.</mark>

<mark>or</mark>

<mark>ii. The push-off test described in Article C13.6.3.c followed by the dynamic test described in Article C13.6.6.</mark>


### Section C > Article C5: .4.15c > None > C5.17.4
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 256

**C5.17.4** <mark>All cars must be fitted with one ERS Status Buzzer unit which:</mark>

<mark>a. Have been supplied by an FIA designated manufacturer and fitted to the car in accordance with the instructions in the Appendix to the Technical and Sporting Regulation.</mark>

<mark>b. Are in working order throughout the Competition.</mark>
...
### Section C > Article C5: .4.15c > None > C5.17.5
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 257
...
<mark>The below is to be rediscussed in TAC once governance is in place.</mark>


### Section C > Article C5: .4.15c > None > C3.17.3
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 257
...
e. the section formed when intersected with any Y-Plane, must have an incidence which lies between 10deg (nose down) and -10deg (nose up). Such an incidence is defined as the angle between a line tangent to any part of the section and Z=0 with the car at its Legality Setup, as defined in Article C10.1.


### Section C > Article C5: .4.15c > None > C3.11.7
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 257
...
i. lie in its entirety between Z = 400 and Z = 590 and forward of X<sub>R</sub> = 390.
...
g. a Fillet Radius no greater than 10mm, may be applied along the intersection between Rear Wing SLM Adjuster Fairing and Rear Wing Assembly, <mark>and Rear Wing Pylon Brace and Rear Wing Assembly</mark>. Fillet Radii, no greater than 4mm, may be applied along all remaining intersections with Rear Wing Assembly.

h. they, <mark>except for the Rear Wing Pylon Brace</mark>, must be arranged such that they are not visible from below with Rear Wing Assembly in place.



||(c)|(a.i) / (a.iii)|(d)|(e)|(f)|(h)|
|-|-|-|-|-|-|-|
|C3.16.6<br/>F-Scoop<br/>Inlet|Front<br/>Scoop|\[50, 155, 200]<br/>\[0°, 0°, 0°]|15,000|None|i. Except for minimal incidental leakage, all air which enters the Front Scoop Inlet must exit the Front Scoop Outlet.|Influx|
|C3.16.7<br/>F-Scoop<br/>Outlet|Front<br/>Scoop|\[75, 155, 200]<br/>\[0°, 0°, 0°]|15,000|Rear|i. Must lie in its entirety rearward of XW = 100 and above ZW = −50 and no closer than 180mm from the YW axis.<br/>ii. Except for minimal incidental leakage, only air which has entered the Front Scoop Inlet shall exit the Front Scoop Outlet.|Efflux|



### Section C > Article C5: .4.15c > None > C15.7.8
SOURCE_FILE: 2026_f1_regulations_section_c.pdf
SOURCE_PAGE: 258
...
|-|-|-|-|
|Operational|85|Power Units and spare Power Unit elements, ancillaries and components necessary for use by the F1 Team during:<br/>i. All Competitions in the Championship. Minimum number of PU elements, and ancillaries and components per F1 team to be (number of each per driver per season according to Section B of the F1 Regulations) x 2<br/>ii. Testing of Current Cars (TCC) in accordance with Section B of the F1 Regulations<br/>iii. DE with a Current Car and PE with a Current Car.<br/><br/>A maximum of 5000 km per calendar year will be INC within the PUSP for the activities detailed in 85.ii and 85.iii of the table.|INC|
