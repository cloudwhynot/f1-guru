...
<mark>Pink Text:</mark> Changes relative to 2026 FIA F1 Regulations - Section C [Technical] – Iss 15, approved by the WMSC on 27/02/26
<mark>[Red Text]:</mark> Information on applicable Governance and relevant Advisory Committee
<mark>[Orange Text]:</mark> Reference information on relevant FIA F1 Document(s)
<mark>[Green Text]:</mark> Comments / explanations / indication of further work: non-binding and non-regulatory
...
d. Irrespective of (b), ~~and except for regions within the three holes defined in Article C3.6,~~ a tolerance of Z = ±2mm will be accepted for parts of the <mark>Floor Bodywork</mark> ~~car~~ forward of X<sub>R</sub>=−335 and <mark>Plank Assembly,</mark> ~~coincident with the those surfaces~~ visible from below. ~~of the following RVs:~~
...
iv. within 5mm of the Fillet Radii permitted as part of the Main Floor Trim and Combination, where the radius of curvature must be no less than 5mm ~~10mm~~.
...
iv. have a circular cross section ~~with a diameter no more than 5mm and lie in its entirety within a 5mm diameter right circular cylinder~~, except within 25mm of the inboard and outboard attachment points, or within 10mm of any adjustment mechanism.
...
i. lie in its entirety within a 40mm diameter right circular cylinder and RV-FLOOR-BRACE, ~~except within 2mm of **Forward Chassis** and 35mm of the intersection point of the right circular cylinder’s axis and **Forward Chassis**.~~
...
<mark>Front Drum Rear Deflector Bodywork must:</mark>
<mark>c. be no more than 15mm thick (being the minimum distance when measured normal to the surface), if visible from inboard.</mark>
<mark>Furthermore:</mark>
<mark>d. Compliance with (c) is not required within 5mm of the side-view boundary of **Front Drum Rear Deflector** when viewed from inboard.</mark>
...
The result of this union will be known as **“Rear Wheel Bodywork Assembly”**, which must form a single, simply connected volume ~~with the Debris Guards removed~~.
...
measured along the loading axis, when a 50N point load is applied in an inward direction normal to the car centre plane using a spherical 15mm diameter tip at [X<sub>R</sub>, Z] = [~~675~~ <mark>670</mark>, 550]. The deflection will be measured relative to the opposite RWEP at the same X and Z location and in the direction of the load.
...
f. With exception of <mark>ERS Auxiliary Circuit</mark> ~~auxiliary circuits~~, electrical energy with an instantaneous power higher than 2W may not flow from CU-K logic or driver boards (usually low voltage parts) into the CU-K power stage (usually HV). This must be guaranteed by design and verifiable by inspection.
...
**C5.6.2** The addition of any substance other than fuel, as described in Article ~~C5.11.3~~ C5.9.3, into the air destined for combustion is forbidden. Exhaust gas recirculation is forbidden.
...
**C5.12.5** The driver maximum power demand cannot be increased during any power limited pending or power limited period, except when the <mark>~~overtake mode~~</mark> Boost is selected by the driver, or, subject to Article B7.2.1, when a reset of any power reduction is permitted.
...
**C5.12.8** Specification of power limited pending, power limited, ~~overtake mode~~ <mark>Boost</mark> mode and details of the implementation in the FIA Standard ECU of the application and monitoring of Article C5.12 may be found in the document <mark>FIA-F1-DOC-058</mark>.
...
~~the axis Y<sub>W</sub> and up to 1mm deep for wheel branding, logo, or part numbers.~~
...
* iv. Parts of the ~~SLM~~ SEM adjustment system.
...
**C15.1.4** No parts of the car may be made from metallic materials that have a specific modulus of elasticity greater than 40 GPa/(g/cm3). Tests to establish conformity will be carried out in accordance with FIA Test Procedure 03/03, <mark>contained in FIA-F1-DOC-114</mark> ~~a copy of which may be found in the Appendix to the Technical and Sporting Regulations.~~
...
> <span style="color: red">*Advisory Committee: TAC*</span>
> <span style="color: red">*Governance: F1 Commission / WMSC*</span>
...
*   a. The supplier must comply with the requirements set in Appendix <mark>~~C8~~</mark> A7, Paragraph 2.1.
...
![Drawing 1: Crankshaft Mass diagram showing the measurement area between the centre of the front and rear main journals.](page_220_image_1_v2.jpg)

![Drawing 2: Camera and Transponder Locations diagram showing various numbered and lettered positions on a Formula 1 car.](page_220_image_2_v2.jpg)

![Technical drawing of the Cockpit Cross Section Template showing dimensions for the outer and inner templates, including radii R50, R75, R25, and R50, and linear dimensions 300, 275, 250, and 50.](page_221_image_1_v2.jpg)

*See Article 13.3.1 & Article 14.6.7*

<page_header>
|Drawing 4|![FIA Logo](page_221_image_2_v2.jpg)|Turbocharger Compressor and Turbine key Dimensions (Article C5.3.5)|
|-|-|-|
</page_header>

![Technical diagram of a turbocharger compressor and turbine showing key dimensions labeled A, B, C, D, E and detailed views of blade profiles with parameters f, g, h, i, j, k.](page_221_image_2_v2.jpg)

# Drawing 5 | ![FIA Logo](page_222_image_1_v2.jpg) | Cylinder key planes and dimensions

![Technical diagram showing cylinder key planes, including Outboard and Inboard (towards vee) directions, Transverse Plane, Longitudinal Plane, Lateral Plane, Crankshaft Centreline, Cylinder Centreline, Intake Valve Axes, Exhaust Valve Axes, and Injector Axis at 70° +/- 5°. A yellow quadrilateral indicates where the Spark Plug Axis must pass.](page_222_image_1_v2.jpg)

Spark Plug Axis must pass through yellow quadrilateral

Article C5.4.15c

# Drawing 6 | ![FIA Logo](page_222_image_1_v2.jpg) | Top deck and deck height definition

![Technical diagram of an engine block cross-section showing the Crankcase, Cylinder Head, Top Deck, and Crank Centerline. It defines the Deck Height as the distance from the Crank Centerline to the Top Deck. A "Sealing feature, if fitted" is also indicated.](page_222_image_1_v2.jpg)

|Drawing 7|![FIA Logo](page_223_image_2_v2.jpg)|Bearing Dimension Definitions (Articles C5.4.6, C5.4.7)|
|-|-|-|
![Diagram showing bearing width and minimum journal diameter definitions.](page_223_image_1_v2.jpg)

|Drawing 8|![FIA Logo](page_223_image_2_v2.jpg)|Additive Manufacture in the Exhaust Assembly (Article C15.8.7)|
|-|-|-|
![Diagram of an exhaust assembly showing ICE and TC components with additive manufacture dimension limits.](page_223_chart_1_v2.jpg)
...
![Technical drawing of a Formula 1 survival cell showing the location and specifications for emergency indicators: Clutch Disengagement, Impact Warning Light, and ERS Safety Light.](page_224_image_1_v2.jpg)
...
**Black Text**: Text unchanged from current Issue of 2026 F1 technical Regulations - Section C
<mark>**Pink Text**</mark>: <mark>Changes relative to FIA 2026 F1 Regulations - Section C [Technical] – approved at the current issue.</mark>
<mark>**Purple Text**</mark>: <mark>Changes relative to FIA 2026 F1 Regulations - Section C [Technical] – approved at a previous issue.</mark>
